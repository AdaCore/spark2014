...
Theorem WP_parameter_def : ((in_range arg1)
                            /\ ((in_range arg2)
                                /\ ((in_range res1)
                                    /\ ((in_range res2)
                                        /\ ((~ (arg2 = 0%Z))
                                            /\ ((res1 = (ZArith.BinInt.Z.modulo arg1 arg2))
                                                /\ (res2 = (ZArith.BinInt.Z.modulo (-arg1)%Z (-arg2)%Z)))))))) ->
                           (*      Post => Res2 = - Res1;                                                                                                 *)
                           (*              ^ spark-arithmetic_lemmas.ads:56:14:instantiated:spark-long_integer_arithmetic_lemmas.ads:3:1:VC_POSTCONDITION *)
                           (res2 = (-res1)%Z).
(* Why3 intros (h1,(h2,(h3,(h4,(h5,(h6,h7)))))). *)
