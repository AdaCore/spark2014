...
(* Why3 assumption *)
Definition in_range1 (x:Z): Prop := (0%Z <= x)%Z /\ (x <= 2147483647%Z)%Z.
...
Definition dynamic_invariant1 (temp___expr_150:Z) (temp___is_init_147:bool)
  ...
  ((temp___is_init_147 = true) \/ (0%Z <= 2147483647%Z)%Z) -> (in_range1
  temp___expr_150).
...
Theorem WP_parameter_def : ((in_range arg1)
                           ...
                           (*              ^ spark-arithmetic_lemmas.ads:61:14:instantiated:spark-integer_arithmetic_lemmas.ads:31:1:VC_POSTCONDITION *)
