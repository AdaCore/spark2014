...
Theorem WP_parameter_def : ((in_range arg2) /\ (ule arg1
                           ...
                           (*               ^ spark-mod_arithmetic_lemmas.ads:102:15:instantiated:spark-mod64_arithmetic_lemmas.ads:33:1:VC_POSTCONDITION *)
                           ((urem (mul arg1 arg2) arg2) = (of_int 0%Z)).
...
rewrite to_uint_mul.
assert (to_uint arg1 * to_uint arg2 <= 18446744073709551615) as no_ovfl_mult.
assert (0 <= 18446744073709551615) as uint_last_nat by auto with zarith.
apply (div_then_mult _ _ _ arg2_pos uint_last_nat pre).
assert (EuclideanDivision.mod1 (to_uint arg1 * to_uint arg2) 18446744073709551616 = to_uint arg1 * to_uint arg2) as mod_noop_on_mult.
