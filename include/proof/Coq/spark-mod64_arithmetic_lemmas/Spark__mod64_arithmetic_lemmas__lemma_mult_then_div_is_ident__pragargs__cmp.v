...
(* Why3 goal *)
Theorem WP_parameter_def : ((in_range arg2) /\ (ule arg1
                            (udiv (of_int 18446744073709551615%Z) arg2))) ->
                           (*      Post => (Arg1 * Arg2) / Arg2 = Arg1;                                                                                  *)
                           (*               ^ spark-mod_arithmetic_lemmas.ads:78:15:instantiated:spark-mod64_arithmetic_lemmas.ads:33:1:VC_POSTCONDITION *)
                           ((udiv (mul arg1 arg2) arg2) = arg1).
intros (h1,h2).
Open Scope Z_scope.
...
destruct h1, a.
unfold ule in H, H0, h2.
rewrite to_uint_udiv in h2.
rewrite to_uint_of_int in H, H0, h2 by auto with zarith.
unfold EuclideanDivision.div in h2.
case Z_le_dec in h2; [|contradict n; apply Z_mod_lt; auto with zarith].
...
* assert (to_uint arg2 <> 0) as Arg2_Pos by auto with zarith.
  apply (Z.div_mul _ _ Arg2_Pos).

* split.
  auto with zarith.
  assert (0 <= to_uint arg2) as Arg2_Nat by auto with zarith.
  pose (Int.CompatOrderMult (to_uint arg1) (18446744073709551615 / to_uint arg2) (to_uint arg2) h2 Arg2_Nat).
  replace (18446744073709551615 / to_uint arg2 * to_uint arg2) with (to_uint arg2 * (18446744073709551615 / to_uint arg2)) in l1 by auto with zarith.
  assert (0 < to_uint arg2) as Arg2_Pos by auto with zarith.
  pose (Z.mul_div_le 18446744073709551615 (to_uint arg2) Arg2_Pos).
  auto with zarith.
