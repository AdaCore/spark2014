...
(* Why3 goal *)
Theorem WP_parameter_def : ((in_range denom) /\ (ule val1 val2)) ->
                           (*      Post => Val1 / Denom <= Val2 / Denom;                                                                                *)
                           (*              ^ spark-mod_arithmetic_lemmas.ads:70:14:instantiated:spark-mod64_arithmetic_lemmas.ads:33:1:VC_POSTCONDITION *)
