...
--  Similar to SPARK.Containers.Formal.Vectors. The main difference is that
...
package SPARK.Containers.Formal.Indefinite_Vectors with
  SPARK_Mode,
...
is
   ...
   with
     Global => null,
     Post   =>
       Indefinite_Vectors.Length (To_Vector'Result) = Length
...
end SPARK.Containers.Formal.Indefinite_Vectors;
