procedure Access_Conv_Null with SPARK_Mode is
   ...
   X_1 : PS_Int := null;   -- @RESOURCE_LEAK_AT_END_OF_SCOPE:PASS
   B_1 : Boolean := F (Gen_Int (X_1)); -- @RESOURCE_LEAK:NONE
   Y_1 : R := (F => Gen_Int (X_1));    -- @RESOURCE_LEAK:PASS

   X_2 : PS_Int := null;       -- @RESOURCE_LEAK_AT_END_OF_SCOPE:PASS
   Y_2 : R_2 := (F => new R'               -- @RESOURCE_LEAK:FAIL
                   (F => Gen_Int (X_2)));  -- @RESOURCE_LEAK:PASS

   X_3 : PS_Int := null;        -- @RESOURCE_LEAK_AT_END_OF_SCOPE:PASS
   Y_3 : R_2 := (F => Gen_R (PS_R'(new R'   -- @RESOURCE_LEAK:FAIL
                   (F => Gen_Int (X_3))))); -- @RESOURCE_LEAK:PASS
   ...
   Y_4 : RC := (F => Cst_Int (C));      -- @RESOURCE_LEAK:PASS

   Y_5 : RC_2 := (F => new RC'            -- @RESOURCE_LEAK:FAIL
                    (F => Cst_Int (C)));  -- @RESOURCE_LEAK:PASS
