...
package body Tests is
   ...
   --     Z : Nice_Widget_T := Nice_Widget_T (Y);
   --  begin
   --     N := Y.Hash;
   --     M := Z.X;
   --     O := Z.Round;
   ...
   procedure Test_29 (A  : in out Widget_T;
                      B  : in out Pair;
                      C  : in     Pair;
                      D  : in out Widget_T;
                      E  :    out Widget_T)
   ...
   begin
      ...
      A                  := C.A; -- not right
      Widget_T (D)       := C.A;
      Widget_T'Class (E) := Widget_T'Class (C.A); -- not right
   end Test_29;

   procedure Test_30 (W  : in     Widget_T;
                      O1 :    out Integer)
   with Global => null,
        Extensions_Visible
   is
      procedure Test_30_Stuff
      with Global => (Input  => W,
                      Output => O1)
      is
         Tmp : Widget_T'Class := W;
      begin
         O1 := Tmp.Hash;
      end Test_30_Stuff;
   begin
