procedure P_Slice with SPARK_Mode is
   Last : constant := 3;
      ...
      L2 : for I21 in Index loop
         L3 : for I22 in Index loop
            L4 : for I1 in Index loop
               X (I3) (I21, I22) (I1 .. Last - 1) := (others => 1);
            end loop L4;
         end loop L3;
      end loop L2;
      pragma Assert (for all I3 in Index =>           --@ASSERT:PASS
                       (for all I21 in Index =>
                          (for all I22 in Index =>
                               X (I3) (I21, I22) (Last) = Y (I3) (I21, I22) (Last))));
   end loop L1;
end P_Slice;
