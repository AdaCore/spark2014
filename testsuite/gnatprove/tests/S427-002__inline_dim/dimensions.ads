...
package Dimensions is
   ...
   type Vector_Type is record
      dx : Dimensions.Length;
      dy : Dimensions.Length;
   end record;
   ...
   type Movement_Type is record
      Vector   : Vector_Type;
      Rotation : Dimensions.Normalized_Angle;
   end record;
   ...
   package Angle_Numerics is new Ada.Numerics.Generic_Elementary_Functions (Dimensions.Angle);
   package Mks_Numerics is new Ada.Numerics.Generic_Elementary_Functions (Dimensions.Mks_Type);
