...
print_spark_contract("Pkg.Flip")
print_spark_contract("Pkg.Flop")
print_spark_contract("Pkg.No_Globals")
print_contract("Pkg.Flip")
print_contract("Pkg.Flop")
print_contract("Pkg.No_Globals")
