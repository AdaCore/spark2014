...
is
   ...
   Invalid_Transition_Array : constant
     Invalid_Transition_Array_T := Invalid_Transition_Array_T'(
        ...
        -- This error seed is equivalent to missing an invalid transition
        -- from this transition table. This should be identified by
        -- the second assert statement in the body of Progress_SM.
   ...
   function My_SM(State : in States_T; Trigger: in Triggers_T)
     ...
     (case State is
         ...
         -- This makes "Start" a state that is inaccessble.
         -- This error will be picked up by the first assert
         -- statement in the body of Progress_SM.
         when Start =>
