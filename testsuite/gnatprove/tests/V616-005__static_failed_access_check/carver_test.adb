...
is
    ...
    type Constant_Integer_Array_Ptr_Type is not null access constant Integer_Array_Type;
    package C is new Carver(Integer, Natural, Integer_Array_Type, Constant_Integer_Array_Ptr_Type);
    IA : aliased constant Integer_Array_Type := (1 => 1, 2 => 2);
    IAP : constant Constant_Integer_Array_Ptr_Type := IA'Access;

    procedure Execute is
        A : C.Carved_Array_Type := C.Make_Carved_Array(IAP);
    begin
