...
procedure Main is
   ...
   procedure Check_Pred_0 with Always_Terminates => False is
      A : Chars_Ptr := New_String ("hello");
   begin
      Update (A, 0, String'("hello!"), True); --@PRECONDITION:FAIL
   end Check_Pred_0;

   procedure Check_Pred_Last with Always_Terminates => False is
      A : Chars_Ptr := New_String ("hello");
   begin
   ...
   procedure Check_Update_Effect with Always_Terminates => False is
      A : Chars_Ptr := New_String ("hello");
