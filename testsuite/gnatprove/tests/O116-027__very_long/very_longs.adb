...
package body Very_Longs is
   ...
   begin
      ...
      for I in L.Long_Digits'Range loop
         -- These need to be loop invariants. If they are assertions outside the loop, the
         -- assertion at the bottom of the loop is unproved. This is true even though the
         -- expressions in the invariants are not changed by the loop.
         pragma Loop_Invariant
           (L.Long_Digits'First = R.Long_Digits'First and
            L.Long_Digits'First = Result.Long_Digits'First);
         pragma Loop_Invariant
           (L.Long_Digits'Last  = R.Long_Digits'Last and
              L.Long_Digits'Last  = Result.Long_Digits'Last );
   ...
   begin
      ...
      for I in L.Long_Digits'Range loop
         ...
         pragma Assert(I in Result.Long_Digits'Range);
