...
package Conts.Functional.Base with SPARK_Mode => Off is
   ...
   function Prepend (C : Container; E : Element_Type) return Container;
   --  Return a new container which is C prepended with E.

   function Delete (C : Container; I : Index_Type) return Container;
   --  Return a new container where element at index I has been deleted.
