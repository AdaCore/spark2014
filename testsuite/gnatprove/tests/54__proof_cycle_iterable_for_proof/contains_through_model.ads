...
package Contains_Through_Model with SPARK_Mode is
   ...
   private
      ...
      function Element (X : T; Y : C) return Integer is
        (X.Content (Integer (Y)));
      function Contains (X : T; I : Integer) return Boolean is
         (for some E of X => Contains_Through_Model_Id (I) = E);
