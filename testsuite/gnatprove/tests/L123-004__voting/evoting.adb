...
procedure eVoting is
   ...
   type Candidate_Name_Array_t is
     array (Candidate_Number_t) of BS.Bounded_String;
   ...
   procedure Read_Candidates(candidates : out Candidate_Name_Array_t;
      ...
      last : Natural;
      item : String(1..BS.Max_Length);
   begin
      candidates(candidates'First) := BS.To_Bounded_String("No vote");
      ...
      while not(End_Of_File(file))
         ...
         candidates(current_candidate) :=
           BS.To_Bounded_String(item(1..last));
   ...
   begin
         ...
         Put(". ");
         Put(BS.To_String(candidates(candidate_id)));
