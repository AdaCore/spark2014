package body Assume_And_Assert_And_Cut_Illegal is
   procedure Prover_Forgets_After_Assert_And_Cut is
      --  TU: 1. Pragma Assert_And_Cut is an assertion the same as a pragma
      --  Assert except it also acts as a cut point in formal verification. The
      --  cut point means that a prover is free to forget all information about
