package Dynamic_Preds_Array
  with SPARK_Mode
is
   subtype Even is Integer with Dynamic_Predicate => Even mod 2 = 0;

   type Even_Pair is array (1 .. 2) of Even;

   type Ext_Even_Pair is array (1 .. 2) of Integer
     with Dynamic_Predicate => Ext_Even_Pair(1) in Even and Ext_Even_Pair(2) in Even;
   ...
   subtype Even_Close_Pair is Even_Pair
     with Dynamic_Predicate => Even_Close_Pair(2) = Even_Close_Pair(1) + 2;
   ...
   function Get_Constant_Even_Pair return Even_Pair
     with Post => Get_Constant_Even_Pair'Result(1) = 0
                    and then
                  Get_Constant_Even_Pair'Result(2) = 0;
