(benchmark fa_test_c.1
  :logic AUFNIRA
  :extrasorts ( unsigned_byte bit___type real___type )
  :extrafuns
  ( (bit___false Int )
    (bit___true Int )
    (unsigned_byte__base__first Int )
    (unsigned_byte__base__last Int )
    (unsigned_byte__first Int )
    (unsigned_byte__last Int )
    (unsigned_byte__size Int )
    ...
    (unsigned_byte___bit_eq Int Int Int )
  )
  :extrapreds
  ( (riposte__has_ce)
  ...
  :assumption
  (iff riposte__has_ce true )
  :assumption
  (<= 0 unsigned_byte__size )
  :assumption
  (= unsigned_byte__first 0 )
  :assumption
  (= unsigned_byte__last 255 )
  :assumption
  (<= unsigned_byte__base__first unsigned_byte__base__last )
  :assumption
  (<= unsigned_byte__base__first unsigned_byte__first )
  :assumption
  (<= unsigned_byte__last unsigned_byte__base__last )
  :assumption
  (forall
      (?X Int )
  ...
  (forall
      (?x Int ) (?y Int )
    (iff
      (= (unsigned_byte___bit_eq ?x ?y ) bit___true )
      (= ?x ?y )
    )
  )
  :assumption
  ...
  (not
    (or
      (forall
        ...
        (implies
          (and
            (<= unsigned_byte__first ?n_ )
            (<= ?n_ unsigned_byte__last )
          )
          (< (+ ?n_ 1 ) unsigned_byte__last )
        )
      )
      (forall
          (?n_ Int )
