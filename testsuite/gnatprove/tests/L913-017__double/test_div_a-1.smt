(benchmark test_div_a.1
  :logic AUFNIRA
  :extrasorts ( byte bit___type real___type )
  :extrafuns 
  ( (bit___false Int )
    (bit___true Int )
    (byte__base__first Int )
    (byte__base__last Int )
    (byte__first Int )
    (byte__last Int )
    (byte__size Int )
    (n Int )
  ...
  (= byte__last 127 )
  :assumption
  (<= byte__base__first byte__base__last )
  :assumption
  (<= byte__base__first byte__first )
  :assumption
  (<= byte__last byte__base__last )
  :assumption
  (forall
      (?X Int )
  ...
  (forall
      (?x Int ) (?y Int )
    (iff (= (byte___bit_eq ?x ?y ) bit___true ) (= ?x ?y ) )
  )
  :assumption
  (forall
      (?x Int ) (?y Int )
