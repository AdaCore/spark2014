package Tagged_Component_Check with SPARK_Mode is
   ...
   package Q is
      package P1 is
         type Root is tagged record
            F : Natural := Hide (0); --@RANGE_CHECK:FAIL
         end record;
         type C is new Root with record
            G : Natural := Hide (1); --@RANGE_CHECK:FAIL
         end record;
      end P1;

      package P2 is
         type Root is tagged record
            F : Natural := Hide (2); --@RANGE_CHECK:FAIL
         end record;
      ...
      package P4 is
         type Root is tagged record
            F : Natural := Hide (6); --@RANGE_CHECK:FAIL
         end record;
         type C is new Root with private;
      private
         pragma SPARK_Mode (Off);
      ...
      type D1 is new P1.C with record
         H : Natural := Hide (10); --@RANGE_CHECK:FAIL
      end record;

      type D2 is new P2.C with record
         H : Natural := Hide (11); --@RANGE_CHECK:FAIL
      end record;

      type D3 is new P3.C with record
         H : Natural := Hide (12); --@RANGE_CHECK:FAIL
      end record;

      type D4 is new P4.C with record
         H : Natural := Hide (13); --@RANGE_CHECK:FAIL
      end record;

      type D5 is new P5.C with record
         H : Natural := Hide (14); --@RANGE_CHECK:FAIL
      end record;
   end Q;
   ...
   package R is
      package P1 is
         type Root is tagged record
            F : Natural := Hide (15); --@RANGE_CHECK:FAIL
         end record;
         type C is new Root with record
            G : Natural := Hide (16); --@RANGE_CHECK:FAIL
         end record;
      end P1;

      package P2 is
         type Root is tagged record
            F : Natural := Hide (17); --@RANGE_CHECK:FAIL
         end record;
         type C is new Root with private;
      private
         type C is new Root with record
      ...
      package P4 is
         type Root is tagged record
            F : Natural := Hide (21); --@RANGE_CHECK:FAIL
         end record;
         type C is new Root with private;
      private
         pragma SPARK_Mode (Off);
