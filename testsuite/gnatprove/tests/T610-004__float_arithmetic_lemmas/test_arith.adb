...
is
   ...
   procedure Mult_Is_Antimonotonic (X1, X2 : Small_Float; Y : Small_Nat_Float; R1, R2 : out Float) with
     Pre => X1 <= X2,
     Post => R2 <= R1
   is
   begin
   ...
   procedure Div_Is_Antimonotonic (X1, X2 : Small_Float; Y : Small_Pos_Float; R1, R2 : out Float) with
     Pre => X1 <= X2,
     Post => R2 <= R1
   is
   begin
