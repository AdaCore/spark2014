...
--  This package defines specific components of post-operation for
...
package Sparkify.Post_Operations is

   --  The structure of this package is similar to Sparkify.Pre_Operations
   ...
   Specific_Post_Operation : array (Flat_Element_Kinds) of Op_Access :=
     (Not_An_Element => No_Action'Access,
      ...
      An_Unknown_Pragma => No_Action'Access,
   ...
   ------------------------------------------------------------
      ...
      --  A_Defining_Enumeration_Literal => No_Action'Access,
      ...
      An_Ordinary_Type_Declaration => No_Action'Access,

      A_Task_Type_Declaration ..
      A_Protected_Type_Declaration => No_Action'Access,

--      An_Incomplete_Type_Declaration => A_Declaration_Post_Op'Access,
      ...
      A_Function_Declaration => No_Action'Access,

      A_Parameter_Specification => No_Action'Access,

      A_Procedure_Body_Declaration ..
      A_Function_Body_Declaration => A_Subprogram_Unit_Post_Op'Access,
      ...
      A_Package_Declaration ..
      A_Package_Body_Declaration =>
          A_Package_Declaration_Post_Op'Access,
      ...
      A_Generic_Package_Declaration => A_Package_Declaration_Post_Op'Access,

      A_Package_Instantiation ..
      --  A_Procedure_Instantiation,                 -- 12.3
      A_Function_Instantiation => No_Action'Access,
      --
--      A_Formal_Object_Declaration => A_Declaration_Post_Op'Access,
...
--         A_Program_Unit_Declaration_Post_Op'Access,
         No_Action'Access,
   ...
   --  A_Tagged_Record_Type_Definition => No_Action'Access,
   ...
   --  A_Synchronized_Interface => An_Interface_Definition_Pre_Op'Access,
   ...
   --  literal, corresponds to subtype Internal_Constraint_Kinds
      ...
      A_Discrete_Subtype_Indication => No_Action'Access,
...
--      An_Unknown_Discriminant_Part => No_Action'Access,
      ...
      An_Anonymous_Access_To_Protected_Function  => No_Action'Access,

      A_Private_Type_Definition ..
      A_Tagged_Private_Type_Definition => No_Action'Access,

      A_Private_Extension_Definition => No_Action'Access,
      ...
      A_Formal_Tagged_Private_Type_Definition => No_Action'Access,

      A_Formal_Derived_Type_Definition => No_Action'Access,
      ...
      A_Formal_Constrained_Array_Definition => No_Action'Access,
      ...
      A_Formal_Access_To_Protected_Function => No_Action'Access,
      ...
      --  A_String_Literal
      An_Identifier => No_Action'Access,
...
--      A_Named_Array_Aggregate => An_Aggregate_Post_Op'Access,
...
--      An_And_Then_Short_Circuit ..
      ...
      An_Asynchronous_Select_Statement => No_Action'Access,

      An_Abort_Statement => No_Action'Access,
      ...
      An_Enumeration_Representation_Clause => No_Action'Access,
