...
begin
   Why3_Keywords.Insert ("alias");
   Why3_Keywords.Insert ("as");
   Why3_Keywords.Insert ("axiom");
   Why3_Keywords.Insert ("bool");
   Why3_Keywords.Insert ("by");
   Why3_Keywords.Insert ("clone");
   Why3_Keywords.Insert ("coinductive");
   Why3_Keywords.Insert ("constant");
   Why3_Keywords.Insert ("else");
   Why3_Keywords.Insert ("end");
   Why3_Keywords.Insert ("epsilon");
   Why3_Keywords.Insert ("exists");
   Why3_Keywords.Insert ("export");
   Why3_Keywords.Insert ("false");
   Why3_Keywords.Insert ("float");
   Why3_Keywords.Insert ("forall");
   Why3_Keywords.Insert ("function");
   Why3_Keywords.Insert ("goal");
   Why3_Keywords.Insert ("if");
   Why3_Keywords.Insert ("import");
   Why3_Keywords.Insert ("in");
   Why3_Keywords.Insert ("inductive");
   Why3_Keywords.Insert ("int");
   Why3_Keywords.Insert ("lemma");
   Why3_Keywords.Insert ("let");
   Why3_Keywords.Insert ("match");
   Why3_Keywords.Insert ("meta");
   Why3_Keywords.Insert ("not");
   Why3_Keywords.Insert ("partial");
   Why3_Keywords.Insert ("predicate");
   Why3_Keywords.Insert ("real");
   Why3_Keywords.Insert ("range");
   Why3_Keywords.Insert ("scope");
   Why3_Keywords.Insert ("so");
   Why3_Keywords.Insert ("then");
   Why3_Keywords.Insert ("theory");
   Why3_Keywords.Insert ("true");
   Why3_Keywords.Insert ("type");
   Why3_Keywords.Insert ("unit");
   Why3_Keywords.Insert ("use");
   Why3_Keywords.Insert ("with");
   --  programs
   Why3_Keywords.Insert ("abstract");
   Why3_Keywords.Insert ("absurd");
   Why3_Keywords.Insert ("any");
   Why3_Keywords.Insert ("assert");
   Why3_Keywords.Insert ("assume");
   Why3_Keywords.Insert ("at");
   Why3_Keywords.Insert ("begin");
   Why3_Keywords.Insert ("break");
   Why3_Keywords.Insert ("check");
   Why3_Keywords.Insert ("continue");
   Why3_Keywords.Insert ("diverges");
   Why3_Keywords.Insert ("do");
   Why3_Keywords.Insert ("done");
   Why3_Keywords.Insert ("downto");
   Why3_Keywords.Insert ("ensures");
   Why3_Keywords.Insert ("exception");
   Why3_Keywords.Insert ("for");
   Why3_Keywords.Insert ("fun");
   Why3_Keywords.Insert ("ghost");
   Why3_Keywords.Insert ("invariant");
   Why3_Keywords.Insert ("label");
   Why3_Keywords.Insert ("module");
   Why3_Keywords.Insert ("mutable");
   Why3_Keywords.Insert ("old");
   Why3_Keywords.Insert ("private");
   Why3_Keywords.Insert ("pure");
   Why3_Keywords.Insert ("raise");
   Why3_Keywords.Insert ("raises");
   Why3_Keywords.Insert ("reads");
   Why3_Keywords.Insert ("rec");
   Why3_Keywords.Insert ("ref");
   Why3_Keywords.Insert ("requires");
   Why3_Keywords.Insert ("result");
   Why3_Keywords.Insert ("return");
   Why3_Keywords.Insert ("returns");
   Why3_Keywords.Insert ("to");
   Why3_Keywords.Insert ("try");
   Why3_Keywords.Insert ("val");
   Why3_Keywords.Insert ("variant");
   Why3_Keywords.Insert ("while");
   Why3_Keywords.Insert ("writes");
end Gnat2Why.Util;
