...
package body Gnat2Why.Types is
   ...
   begin
      if Is_Standard_Boolean_Type (E) or else E = Universal_Fixed then
         ...
         if (Has_Record_Type (E) or else Is_Private_Type (Retysp (E)))
         ...
         --  clones of existing types with the same name and
         ...
         if (not (Has_Record_Type (E) or else Is_Private_Type (Retysp (E)))
