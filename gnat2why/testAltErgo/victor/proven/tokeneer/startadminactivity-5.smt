(benchmark startadminactivity.5.1
  :logic AUFNIRA
  :extrasorts 
  ( admin__t
  ...
  ( (admin__isdoingop admin__t )
    ...
    (adminlogoncanstart admintoken__statetype Int admin__t )
    (adminopcanstart admintoken__statetype Int admin__t )
  ...
  :formula
  (and
    (not (enrolmentisinprogress enclavequiescent ) )
    (implies
