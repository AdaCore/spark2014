  ...
  (and
    ...
    (implies
      ...
      (and
        ...
        (and
          (and
            (and
              (admin__ispresent theadmin__4 )
              (admin__isdoingop theadmin__4 )
            )
            (= latch__state__4 latch__state )
          )
          (= (admin__thecurrentop theadmin__4 ) admin__shutdownop )
        )
      )
    )
    (implies
    ...
    (iff
      (and
        (latch__islocked latch__state__4 )
        (and
          (= (door__thecurrentdoor door__state__4 ) door__open )
          (clock__greaterthanorequal
            (clock__thecurrenttime clock__currenttime )
            (door__prf_alarmtimeout door__state__4 )
          )
        )
      )
      (=
    ...
    (implies
      (= (admin__prf_rolepresent theadmin__4 ) privtypes__guard )
      (and
    ...
    (implies
      (and
        (not (latch__islocked latch__state__4 ) )
        (latch__islocked latch__state )
      )
      (and
        (admintoken__prf_isgood admintoken__state__4 )
    ...
    (implies
      (and
        (admin__isdoingop theadmin__4 )
        (= (admin__thecurrentop theadmin__4 ) admin__overridelock )
      )
      (= (admin__prf_rolepresent theadmin__4 ) privtypes__guard )
    )
    (implies
    ...
    (not
      (and
        (or
          ...
          (or
            (or
              (= status__4 waitingfinishadminop )
              (= status__4 enclavequiescent )
            )
            (= status__4 shutdown )
          )
        )
