(benchmark progressadminactivity.3.1
  :logic AUFNIRA
  :extrasorts 
  ( clock__timet
    latch__statetype
  ...
  :formula
  (and
    (not (enrolmentisinprogress gotadmintoken ) )
    ...
    (or
      ...
      (= status__1 waitingremoveadmintokenfail )
    )
    (implies
      (= status__1 waitingremoveadmintokenfail )
    ...
    (implies
      (= (admin__prf_rolepresent theadmin__1 ) privtypes__guard )
      (and
    ...
    (implies
      (and
        ...
        (= (admin__thecurrentop theadmin__1 ) admin__overridelock )
      )
      (= (admin__prf_rolepresent theadmin__1 ) privtypes__guard )
    )
    (implies
