(benchmark zerop.6.1
  ...
  (and
    (forall
      ...
      (implies
        (and
          (<= a__index__subtype__1__first ?j_ )
          (<= ?j_ (+ loop__1__i 9 ) )
        )
        (= (naturals___arr_element a loop__1__i ) 0 )
      )
    )
    (forall
        (?i___1 Int )
    ...
    (<= 0 loop__1__i )
    (<= a__index__subtype__1__first loop__1__i )
    (<= (+ loop__1__i 11 ) natural__last )
    (<= integer__base__first (+ loop__1__i 11 ) )
    (<= (+ loop__1__i 11 ) integer__base__last )
    (forall
        (?j_ Int )
      (implies
        (and
        ...
        (= (naturals___arr_element a__1 ?j_ ) 0 )
      )
    )
    (forall
        (?j_ Int )
      (implies
        ...
        (=
          (naturals___arr_element a__1 ?j_ )
          (naturals___arr_element a ?j_ )
        )
      )
    )
    (forall
      ...
      (implies
        ...
        (and
          (<= 0 (naturals___arr_element a__1 ?i___1 ) )
          (<= (naturals___arr_element a__1 ?i___1 ) natural__last )
        )
      )
    )
    (< loop__1__i (int___div a__index__subtype__1__last 10 ) )
    (<= 0 integer__size )
    (<= integer__first integer__last )
    (<= integer__base__first integer__base__last )
    (<= integer__base__first integer__first )
    ...
    (not
      (forall
        ...
        (implies
          ...
          (= (naturals___arr_element a__1 (+ loop__1__i 1 ) ) 0 )
        )
      )
    )
  )
