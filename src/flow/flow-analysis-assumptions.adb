...
--                                 B o d y                                  --
--                                                                          --
--              Copyright (C) 2021-2026, Capgemini Engineering              --
--                                                                          --
...
package body Flow.Analysis.Assumptions is
   ...
   procedure Register_Pragma_Assume_Statement (Prag : N_Pragma_Id) is
      ...
      Line   : constant Positive := Positive (Get_Physical_Line_Number (Slc));
   ...
   begin
      ...
      Set_Field
        (Result,
         "entity",
         To_JSON (Entity_To_Subp_Assumption (Get_Flow_Scope (Prag).Ent)));
