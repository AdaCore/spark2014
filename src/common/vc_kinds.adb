...
package body VC_Kinds is
   ...
   is (case Code is
         ...
         when EC_Modifies_Volatile                    =>
           "effectively volatile output of the subprogram not mentioned "
           & "entirely in Modifies contract",
         when EC_Relaxed_Init_Dispatch                =>
           "dispatching operation with Relaxed_Initialization aspect",
         when EC_Relaxed_Init_Initialized_Prefix      =>
           "attribute ""Initialized"" on a prefix which does not have "
           & "relaxed initialization",
         when EC_Relaxed_Init_Part_Generic            =>
           "part of tagged, Unchecked_Union, or effectively volatile object "
           & "or type annotated with relaxed initialization",
         when EC_Relaxed_Init_Part_Of_Tagged          =>
           "part of tagged type with relaxed initialization",
         when EC_Relaxed_Init_Part_Of_Unchecked_Union =>
           "part of Unchecked_Union type with relaxed initialization",
