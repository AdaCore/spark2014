...
package SPARK_Atree.Entities is
   ...
   subtype Constant_Or_Variable_Kind_Id is EE.Constant_Or_Variable_Kind_Id;
   ...
   E_Abstract_State              : Entity_Kind renames EE.E_Abstract_State;
   E_Access_Subtype              : Entity_Kind renames EE.E_Access_Subtype;
   E_Access_Subprogram_Type      : Entity_Kind renames
     EE.E_Access_Subprogram_Type;
   E_Access_Type                 : Entity_Kind renames EE.E_Access_Type;
   E_Array_Subtype               : Entity_Kind renames EE.E_Array_Subtype;
   E_Array_Type                  : Entity_Kind renames EE.E_Array_Type;
   E_Class_Wide_Subtype          : Entity_Kind renames EE.E_Class_Wide_Subtype;
   E_Class_Wide_Type             : Entity_Kind renames EE.E_Class_Wide_Type;
   E_Component                   : Entity_Kind renames EE.E_Component;
   E_Constant                    : Entity_Kind renames EE.E_Constant;
   E_Discriminant                : Entity_Kind renames EE.E_Discriminant;
   E_Entry                       : Entity_Kind renames EE.E_Entry;
   E_Enumeration_Literal         : Entity_Kind renames
     EE.E_Enumeration_Literal;
   E_Exception                   : Entity_Kind renames EE.E_Exception;
   E_Exception_Type              : Entity_Kind renames EE.E_Exception_Type;
   E_Function                    : Entity_Kind renames EE.E_Function;
   E_General_Access_Type         : Entity_Kind renames
     EE.E_General_Access_Type;
   E_In_Parameter                : Entity_Kind renames EE.E_In_Parameter;
   E_In_Out_Parameter            : Entity_Kind renames EE.E_In_Out_Parameter;
   E_Incomplete_Subtype          : Entity_Kind renames EE.E_Incomplete_Subtype;
   E_Incomplete_Type             : Entity_Kind renames EE.E_Incomplete_Type;
   E_Label                       : Entity_Kind renames EE.E_Label;
   E_Limited_Private_Type        : Entity_Kind renames
     EE.E_Limited_Private_Type;
   E_Loop_Parameter              : Entity_Kind renames EE.E_Loop_Parameter;
   E_Loop                        : Entity_Kind renames EE.E_Loop;
   E_Operator                    : Entity_Kind renames EE.E_Operator;
   E_Out_Parameter               : Entity_Kind renames EE.E_Out_Parameter;
   E_Package                     : Entity_Kind renames EE.E_Package;
   E_Package_Body                : Entity_Kind renames EE.E_Package_Body;
   E_Private_Subtype             : Entity_Kind renames EE.E_Private_Subtype;
   E_Private_Type                : Entity_Kind renames EE.E_Private_Type;
   E_Procedure                   : Entity_Kind renames EE.E_Procedure;
   E_Protected_Type              : Entity_Kind renames EE.E_Protected_Type;
   E_Protected_Subtype           : Entity_Kind renames EE.E_Protected_Subtype;
   E_Task_Subtype                : Entity_Kind renames EE.E_Task_Subtype;
   E_Record_Subtype              : Entity_Kind renames EE.E_Record_Subtype;
   E_Record_Subtype_With_Private : Entity_Kind renames
     EE.E_Record_Subtype_With_Private;
   E_Record_Type                 : Entity_Kind renames EE.E_Record_Type;
   ...
   E_Subprogram_Body             : Entity_Kind renames EE.E_Subprogram_Body;
   E_Subprogram_Type             : Entity_Kind renames EE.E_Subprogram_Type;
   E_Task_Type                   : Entity_Kind renames EE.E_Task_Type;
   E_Variable                    : Entity_Kind renames EE.E_Variable;
   E_Void                        : Entity_Kind renames EE.E_Void;

   function "=" (L, R : Entity_Kind) return Boolean renames EE."=";

   function Ekind (E : Entity_Id) return Entity_Kind renames EE.Ekind;
   ...
   function Is_Access_Type (E : Type_Kind_Id) return Boolean
   renames Einfo.Utils.Is_Access_Type;

   function Is_Access_Variable (E : Type_Kind_Id) return Boolean
   renames Sem_Util.Is_Access_Variable;

   function Is_Anonymous_Access_Type (E : Type_Kind_Id) return Boolean
   renames Einfo.Utils.Is_Anonymous_Access_Type;

   function Is_Array_Type (E : Type_Kind_Id) return Boolean
   renames Einfo.Utils.Is_Array_Type;

   function Is_Assignable (E : Object_Kind_Id) return Boolean
   renames Einfo.Utils.Is_Assignable;

   function Is_Boolean_Type (E : Type_Kind_Id) return Boolean
   renames Einfo.Utils.Is_Boolean_Type;

   function Is_Character_Type (E : Type_Kind_Id) return Boolean
   renames EE.Is_Character_Type;

   function Is_Compilation_Unit (E : Entity_Id) return Boolean
   renames EE.Is_Compilation_Unit;

   function Is_Composite_Type (E : Type_Kind_Id) return Boolean
   renames Einfo.Utils.Is_Composite_Type;

   function Is_Concurrent_Type (E : Type_Kind_Id) return Boolean
   renames Einfo.Utils.Is_Concurrent_Type;

   function Is_Constant_Object (E : Object_Kind_Id) return Boolean
   renames Einfo.Utils.Is_Constant_Object;

   function Is_Discriminal (E : Object_Kind_Id) return Boolean
   renames Einfo.Utils.Is_Discriminal;

   function Is_Dispatching_Operation (Subp : Callable_Kind_Id) return Boolean;
   ...
   function Is_Discrete_Type (E : Type_Kind_Id) return Boolean
   renames Einfo.Utils.Is_Discrete_Type;
   ...
   function Is_Elementary_Type (E : Type_Kind_Id) return Boolean
   renames Einfo.Utils.Is_Elementary_Type;

   function Is_Entity_Name (N : Node_Id) return Boolean
   with
     Post =>
       not Is_Entity_Name'Result
       or else (Nkind (N) in N_Has_Entity and then Present (Entity (N)));

   function Is_Entry (E : Entity_Id) return Boolean
   renames Einfo.Utils.Is_Entry;

   function Is_Enumeration_Type (E : Type_Kind_Id) return Boolean
   renames Einfo.Utils.Is_Enumeration_Type;

   function Is_Extended_Precision_Floating_Point_Type
     (E : Type_Kind_Id) return Boolean
   renames Sem_Util.Is_Extended_Precision_Floating_Point_Type;

   function Is_Fixed_Point_Type (E : Type_Kind_Id) return Boolean
   renames Einfo.Utils.Is_Fixed_Point_Type;

   function Is_Floating_Point_Type (E : Type_Kind_Id) return Boolean
   renames Einfo.Utils.Is_Floating_Point_Type;

   function Is_Formal (E : Object_Kind_Id) return Boolean
   renames Einfo.Utils.Is_Formal;

   function Is_Generic_Unit (E : Entity_Id) return Boolean
   renames Einfo.Utils.Is_Generic_Unit;

   function Is_Ghost_Entity (E : Entity_Id) return Boolean
   renames Einfo.Utils.Is_Ghost_Entity;

   function Is_Integer_Type (E : Entity_Id) return Boolean
   renames Einfo.Utils.Is_Integer_Type;

   function Is_Imported (E : Entity_Id) return Boolean renames EE.Is_Imported;

   function Is_Internal (E : Entity_Id) return Boolean renames EE.Is_Internal;

   function Is_Itype (E : Type_Kind_Id) return Boolean renames EE.Is_Itype;
   ...
   function Is_Incomplete_Or_Private_Type (E : Type_Kind_Id) return Boolean
   renames Einfo.Utils.Is_Incomplete_Or_Private_Type;

   function Is_Protected_Type (E : Type_Kind_Id) return Boolean
   renames Einfo.Utils.Is_Protected_Type;

   function Is_Record_Type (E : Type_Kind_Id) return Boolean
   renames Einfo.Utils.Is_Record_Type;
   ...
   renames Einfo.Utils.Is_Subprogram;

   function Is_Subprogram_Or_Entry (E : Entity_Id) return Boolean
   renames Einfo.Utils.Is_Subprogram_Or_Entry;

   function Is_Task_Type (E : Entity_Id) return Boolean
   renames Einfo.Utils.Is_Task_Type;
   ...
   function Is_Universal_Numeric_Type (E : Type_Kind_Id) return Boolean
   renames Sem_Util.Is_Universal_Numeric_Type;

   function Unique_Entity (E : Entity_Id) return Entity_Id
   renames Sem_Util.Unique_Entity;

   function Within_Protected_Type (E : Entity_Id) return Boolean
   renames Sem_Util.Within_Protected_Type;
   ...
   with
     Pre => Present (Aspects.Find_Aspect (Typ, A => Aspects.Aspect_Iterable));

   function Get_Iterable_Type_Primitive
     (Typ : Type_Kind_Id; Nam : Name_Id) return Opt_E_Function_Id
   with
     Pre =>
       Nam
       in Name_Element
   ...
   with
     Post =>
       (if Present (Invariant_Procedure'Result)
        then Einfo.Utils.Number_Formals (Invariant_Procedure'Result) = 1);
   ...
   function Partial_DIC_Procedure
     (Typ : Type_Kind_Id) return Opt_E_Procedure_Id
   with
     Post =>
       (if Present (Partial_DIC_Procedure'Result)
        then Einfo.Utils.Number_Formals (Partial_DIC_Procedure'Result) = 1);

   function Predicate_Function (Typ : Type_Kind_Id) return Opt_E_Function_Id
   with
     Post =>
       (if Present (Predicate_Function'Result)
        then Einfo.Utils.Number_Formals (Predicate_Function'Result) = 1);
   ...
   function Default_Aspect_Value
     (Typ : Scalar_Kind_Id) return Opt_N_Subexpr_Id;
   ...
   function Type_Low_Bound (Typ : Entity_Id) return Opt_N_Subexpr_Id
   with
     Pre =>
       Is_Scalar_Type (Typ) or else Ekind (Typ) = E_String_Literal_Subtype;
   ...
   function Has_Enumeration_Rep_Clause
     (Typ : Enumeration_Kind_Id) return Boolean
   renames Einfo.Entities.Has_Enumeration_Rep_Clause;

   function First_Literal
     (Typ : Enumeration_Kind_Id) return E_Enumeration_Literal_Id
   renames Einfo.Entities.First_Literal;

   function Next_Literal
     (E : E_Enumeration_Literal_Id) return Opt_E_Enumeration_Literal_Id
   renames Einfo.Utils.Next_Literal;

   procedure Next_Literal (E : in out Opt_E_Enumeration_Literal_Id)
   renames Einfo.Utils.Next_Literal;

   function Get_Enum_Lit_From_Pos
     (Typ : Enumeration_Kind_Id; P : Uint) return Node_Id
   with
     Post =>
       Nkind (Get_Enum_Lit_From_Pos'Result)
   ...
   with Pre => not Has_Discriminants (Typ);
   ...
   with
     Post =>
       (if Present (Discr) then SPARK_Util.Is_Not_Hidden_Discriminant (Discr));
   ...
   with
     Pre =>
       Ekind (Typ)
       in Record_Kind | Concurrent_Kind | Incomplete_Or_Private_Kind;
   ...
   function Default_Aspect_Component_Value
     (Typ : Array_Kind_Id) return Opt_N_Subexpr_Id;
   ...
   procedure Next_Index (Index : in out Node_Id)
   ...
   function String_Literal_Length
     (Typ : E_String_Literal_Subtype_Id) return Uint
   renames Einfo.Entities.String_Literal_Length;

   function String_Literal_Low_Bound
     (Typ : E_String_Literal_Subtype_Id) return Node_Id
   ...
   function Can_Never_Be_Null (E : Access_Kind_Id) return Boolean
   renames EE.Can_Never_Be_Null;

   function Is_Access_Constant (E : Access_Kind_Id) return Boolean
   renames EE.Is_Access_Constant;
   ...
   function Discriminant_Default_Value
     (Obj : E_Discriminant_Id) return Opt_N_Subexpr_Id;

   function Enclosing_Type (Obj : Entity_Id) return Type_Kind_Id
   with
     Pre  =>
       Ekind (Obj)
       in E_Discriminant | E_Component | E_Constant | E_In_Parameter
       or else SPARK_Util.Subprograms.Is_Protected_Operation (Obj),
     Post =>
       Ekind (Enclosing_Type'Result)
   ...
   function Is_Abstract_Subprogram (Subp : Callable_Kind_Id) return Boolean;
   ...
   function No_Return (Subp : Callable_Kind_Id) return Boolean
   renames EE.No_Return;
   ...
   function Package_Body_Entity
     (Pack : N_Package_Body_Id) return E_Package_Body_Id;

   function Package_Body (Pack : E_Package_Id) return Opt_N_Package_Body_Id;

   function Private_Declarations_Of_Package
     (Pack : E_Package_Id) return List_Id;
   ...
   function Alignment (Ent : Entity_Id) return Unat
   with
     Pre =>
       (Is_Type (Ent) or else Is_Object (Ent)) and then Known_Alignment (Ent);

   function Enclosing_Declaration (E : Entity_Id) return Node_Id
   with
   ...
   function Esize (Ent : Entity_Id) return Unat
   with
     Pre => (Is_Type (Ent) or else Is_Object (Ent)) and then Known_Esize (Ent);

   function Get_Rep_Item (E : Entity_Id; Nam : Name_Id) return Node_Id
   with
     Pre =>
       Ekind (E) in Protected_Kind | E_Function | E_Procedure | E_Task_Type
       and then Nam in Name_Priority | Name_Interrupt_Priority;

   function Known_Alignment (Ent : Entity_Id) return Boolean
   with Pre => Is_Type (Ent) or else Is_Object (Ent);

   function Known_Component_Size (Ent : Entity_Id) return Boolean
   with Pre => Is_Type (Ent) or else Is_Object (Ent);

   function Known_Esize (Ent : Entity_Id) return Boolean
   with Pre => Is_Type (Ent) or else Is_Object (Ent);

   function Known_RM_Size (Ent : Entity_Id) return Boolean
   with Pre => Is_Type (Ent) or else Is_Object (Ent);

   function Known_To_Precede (Withed, Main : Entity_Id) return Boolean
   with
     Pre => Is_Compilation_Unit (Withed) and then Is_Compilation_Unit (Main);
   ...
   function RM_Size (Typ : Type_Kind_Id) return Unat
   with Pre => Known_RM_Size (Typ);
