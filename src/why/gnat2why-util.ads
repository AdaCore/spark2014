...
package Gnat2Why.Util is
   ...
   function Use_Split_Form_For_Type (E : Type_Kind_Id) return Boolean;
   ...
   function Type_Of_Node (N : Node_Id) return Type_Kind_Id;
   --  @param N any node
   ...
   --  Param_Id. A suitable Id is constructed if none exists.
   ...
   Termination_Condition_Name : W_Identifier_Id := Why_Empty;
   --  Name to use for the evalution of the termination condition of the
   --  current subprogram if any.
