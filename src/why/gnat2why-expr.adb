...
package body Gnat2Why.Expr is
   ...
   begin
      ...
      then
         ...
         T := New_Conditional
           (Condition => +W_Expr_Id'(+Initialized),
            Then_Part => New_Not
      ...
      declare
         ...
         Check_Pred            : constant W_Pred_Id :=
           New_Conditional
             (Condition => +W_Expr_Id'(+Top_Predicate),
              Then_Part =>
   ...
   begin
      ...
      Result := +W_Expr_Id'(New_Binding (Name    => Pred_Id,
                                         Def     => +Expr,
                                         Context => +Result,
                                         Domain  => EW_Pred,
                                         Typ     => Get_Type (+Result)));
   ...
   begin
      ...
      --  We need to call the __move function on Tmp
         ...
         declare
            ...
            W_Expr     : constant W_Expr_Id := Insert_Simple_Conversion
              (Domain => EW_Pterm,
               Expr   => +Tmp,
               To     => Exp_Typ);
   ...
   begin
      ...
      --  given by the quantification.
         ...
         declare
            ...
            W_Wrap_Result : constant W_Prog_Id :=
