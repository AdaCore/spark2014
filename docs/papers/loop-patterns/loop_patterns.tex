...
\newcommand{\spostsym}{\ensuremath{\mathcal{S}}\xspace}
...
\begin{lemma}
  \emph{(\spostsym Correctness)} Operator \spostsym as defined in \spexit,
...
\begin{theorem}
  \emph{(Search Pattern Invariant Capture)} \Inv{\idx} given by \curinv
...
\begin{proof}
  ...
  \begin{align*}
    ...
    &\Leftrightarrow \Inv{\idxinitial}      && \text{by \curinv}
  \end{align*}
  %
