...
\item[(b)] $\spost{B}{\framecond{\prog} \land \preservecond{\prog} \land \initcond{\prog} \land \idx = \idxinitial \land \neg g_{exit}^\at{\idx} \land \phi(\idx)} 
             \Leftrightarrow  
            \framecond{\prog} \land \preservecond{\prog} \land \idx = \idxinitial \land \neg g_{0_{exit}} \land  \phi(\idx+1)$
\item[(c)] $\spost{B}{\framecond{\prog} \land \preservecond{\prog} \land \idxinitial < \idx \leq \idxfinal \land \neg g_{exit}^\at{\idx} \land \phi(\idx)} 
             \Leftrightarrow  
            \framecond{\prog} \land \preservecond{\prog} \land \idxinitial < \idx \leq \idxfinal \land \neg g_{0_{exit}} \land  \phi(\idx+1)$
\end{itemize}
...
\begin{proof}
  ...
  \subproof{\textbf{Presevation case}} 
  Here the proof proceeds by induction on the number of loop round $k=i$.

  \subsubproof{\textbf{Base case : $\idx = \idxinitial$}}  
  We have by Init case
  $$(\initcond{\prog} \land \idx= \idxinitial \land \phi(\idx)) \Rightarrow  (\idx= \idxinitial \land \psi(\idx))$$
  %
  $g_{exit}^\at{\idx}$ is a value preserving hence $\preservecond{\prog} \Rightarrow (g_{exit}^\at{\idx} = g_{0_{exit}})$ so we can write
  \begin{align*}
    \framecond{\prog} \land \preservecond{\prog} \land \initcond{\prog} \land \neg g_{0_{exit}} \land \idx= \idxinitial \land \phi(\idx) \Rightarrow \\
    \framecond{\prog} \land \preservecond{\prog} \land \neg g_{0_{exit}} \land \idx= \idxinitial \land \psi(\idx)
  \end{align*}
  %
  Apply \spmonoton we get 
  \begin{align*}
    \spost{\texttt{B}}{\framecond{\prog} \land \preservecond{\prog} \land \initcond{\prog} \land \neg g_{0_{exit}} \land \idx= \idxinitial \land \phi(\idx)} 
    \Rightarrow\\
    \spost{\texttt{B}}{\framecond{\prog} \land \preservecond{\prog} \land \neg g_{0_{exit}} \land \idx= \idxinitial \land \psi(\idx)}
  \end{align*}
  %
  ...
  \begin{align*}
    \framecond{\prog} \land \preservecond{\prog} \land \idx = \idxinitial \land \neg g_{0_{exit}} \land  \phi(\idx+1)
    \Rightarrow\\
    \spost{\texttt{B}}{\framecond{\prog} \land \preservecond{\prog} \land \neg g_{0_{exit}} \land \idx= \idxinitial \land \psi(\idx)} \quad \quad \mathsf{(1)}
  \end{align*}
  %
  Moreover, $\psi$ is an inductive invariant, and thus, the Hoare triple below holds.
  $$
  ...
  \begin{align*}
    ...
    &\{ \framecond{ \prog} \} \texttt{B} \{ \framecond{ \prog} \}& \quad \quad \mathsf{(3)}
  \end{align*}
  %
  ...
  \begin{align*}
    \spost{\texttt{B}}{\framecond{\prog} \land \preservecond{\prog} \land \idxinitial \leq i \leq \idxfinal \land \neg g_{exit}^\at{\idx} \land \psi(i) } 
    &\Rightarrow &\\
    \framecond{ \prog} \land \preservecond{\prog} \land \psi(i+1) \quad \quad \mathsf{(5)}
  \end{align*}  
  With $\mathsf{(1)}$ and $\mathsf{(5)}$ we get
  \begin{align*}
    \framecond{\prog} \land \preservecond{\prog} \land \idx = \idxinitial+1 \land \neg g_{0_{exit}} \land  \phi(\idx+1)
    \Rightarrow\\
    \framecond{ \prog} \land \preservecond{\prog} \land \psi(i+1) 
  \end{align*}
  \begin{align*}
    \neg g_{0_{exit}} \land  \phi(\idx+1)
    \Rightarrow
  ...
  $$(\forall k)(\idxinitial \leq k \leq \idx \land \phi(k) \Rightarrow \psi(k))$$
  At index $i$ we have
  \begin{align*}
  \framecond{\prog} \land \preservecond{\prog} \land \idxinitial < \idx \leq \idxfinal \land \neg g_{0_{exit}} \land \phi(\idx)  \Rightarrow\\
  \framecond{\prog} \land \preservecond{\prog} \land \idxinitial < \idx \leq \idxfinal \land \neg g_{0_{exit}} \land  \psi(\idx)
  \end{align*}
  %
  Apply \spmonoton we get 
  \begin{align*}
    \spost{\texttt{B}}{\framecond{\prog} \land \preservecond{\prog} \land \idxinitial < \idx \leq \idxfinal \land \neg g_{0_{exit}} \land \phi(\idx)} 
    \Rightarrow\\
    \spost{\texttt{B}}{\framecond{\prog} \land \preservecond{\prog} \land \idxinitial < \idx \leq \idxfinal \land \neg g_{0_{exit}} \land \psi(\idx)}
  \end{align*}
  %
  ...
  \begin{align*}
    \spost{B}{\framecond{\prog} \land \preservecond{\prog} \land \idxinitial < \idx \leq \idxfinal \land \neg g_{exit}^\at{\idx} \land \phi(\idx)} 
             \Leftrightarrow  \\
    \framecond{\prog} \land \preservecond{\prog} \land \idxinitial < \idx \leq \idxfinal \land \neg g_{0_{exit}} \land  \phi(\idx+1)
  \end{align*}
  so 
  \begin{align*}
   \framecond{\prog} \land \preservecond{\prog} \land \idxinitial < \idx \leq \idxfinal \land \neg g_{0_{exit}} \land  \phi(\idx+1)
   \Rightarrow \\
   \spost{\texttt{B}}{\framecond{\prog} \land \preservecond{\prog} \land \idxinitial < \idx \leq \idxfinal \land \neg g_{0_{exit}} \land \psi(\idx)} \quad \mathsf{(6)}
  \end{align*}
  %
