...
\subproof{reduced case: $\gstatement{exit}{1..n} = \o{} \land \gstatement{assign}{1..m} = \o{}$}
...
\subproof{general case}

There may be others guarded exit and guarded assignment statements
...
2. general case : there may be others guarded exit and guarded assignment statements
  ...
  \begin{align*}
    ...
    &=\spost{\gstatement{assign}{1..m}}{\spost{\gstatement{exit}{1..n} 
             || \mathit{true} \rightarrow a := e^\at{\idx}}{\Inv{\idx}}}       && \text{by \spseq} \\ 
    &=\spost{\gstatement{assign}{1..m}}{\spost{\gstatement{exit}{1..n}}
             {\spost{\mathit{true} \rightarrow a := e^\at{\idx}}{\Inv{\idx}}}} && \text{by \sppar} \\ 
    &=\spost{\gstatement{assign}{1..m}}
       {\spost{\gstatement{exit}{1..n}}{\Inv{\idx+1}}}                         && \text{by reduce case} \\ 
    &\Rightarrow \spost{\gstatement{assign}{1..m}}{\Inv{\idx+1}}               && \text{by lemma \ref{lemma:sp-g-exits}} \\ 
    &\Rightarrow \Inv{\idx+1}                                                  && \text{by lemma \ref{lemma:sp-g-assignments}}
  \end{align*}
  % 
...
\pattern{
  ...
  & (a \circ a_0) \land (\forall k)(\seen{k} \impl a \circ e_0^\at{k})\\
  \land & ((a = a_0) \lor (\exists j)(\seen{j} \land a = e_0^\at{j})) 
}
%
...
\begin{proof}
  ...
  \subproof{reduced case: $\gstatement{exit}{1..n} = \o{} \land
    \gstatement{assign}{1..m} = \o{}$}
  ...
  \begin{align*}
    A &\symdef\neg (a \bullet e_0^\at{\idx}) \land \Inv{\idx} \\
    A &\symdef(a = e_0^\at{\idx}) \land (\exists b) ((b \bullet e_0^\at{\idx}) \land \Inv{\idx}[a\leftarrow b])) \\
  \end{align*}
