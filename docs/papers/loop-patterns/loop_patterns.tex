...
\begin{proof}
  ...
  $$(\idx= \idxinitial \land \initcond{\prog}) \Rightarrow \psi(\idx)$$
...
\\
  ...
  \end{align*}
  %
  With $\mathsf{(2)}$ and $\mathsf{(1)}$ for $\idx = \idxinitial \land \idxfinal \geq \idxinitial$ 
  (notice that the case $\idxfinal < \idxinitial$ is vacuosly true) we get that
  \begin{align*}
    \framecond{\prog} \land \preservecond{\prog}{\idxinitial+1} \land  \phi(\idxinitial+1)
  ...
  $$
  \idxinitial < \idx \leq \idxfinal \land \framecond{\prog} \land \preservecond{\prog}{\idx} \land \phi(\idx) 
  \Rightarrow 
  \psi(i)
  $$
  %
  ...
  By adding $g_{exit}$ to both side of the formula we get that
  \begin{align*}
  \idxinitial < \idx \leq \idxfinal \land \framecond{\prog} \land \preservecond{\prog}{\idx} \land \neg g_{exit} \land \phi(i) 
  \Rightarrow \\
  ...
  By applying \spmonoton, we get that
  \begin{align*}
    \spost{\texttt{B}}{\idxinitial < \idx \leq \idxfinal \land \framecond{\prog} \land \preservecond{\prog}{\idx} \land \neg g_{exit} \land \phi(i)} 
    \Rightarrow\\
  ...
  \begin{align*}
    \spost{B}{\idxinitial < \idx \leq \idxfinal \land \framecond{\prog} \land \preservecond{\prog}{\idx} \land \neg g_{exit} \land \phi(\idx)} 
             \Leftrightarrow  \\
    \idxinitial < \idx \leq \idxfinal \land \framecond{\prog} \land \preservecond{\prog}{\idx+1} \land \phi(\idx+1)
  \end{align*}
  %
