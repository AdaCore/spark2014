...
1. Case of guarded exits : without losing information on the generality, 
...
1. Case of guarded assignments : without losing information on the generality, 
...
1. reduced case: $\gstatement{exit}{1..n} = \o{} \land \gstatement{assign}{1..m} = \o{}$\\
  ...
  \begin{align*}
    ...
    &=\neg t_0^\at{\idx} \land \Inv{\idx} && \text{by \vpp}\\
...
1. reduced case: $\gstatement{exit}{1..n} = \o{} \land \gstatement{assign}{1..m} = \o{}$
  ...
  \end{align*}
  %
  1.1 When $\bullet \in \{<, >\}$ then $\neg (a \bullet e_0^\at{\idx}) = a \circ e_0^\at{k}$
  \begin{align*}
    &A= \neg (a \bullet e_0^\at{\idx}) \land \Inv{\idx} \\
    &~~= \neg (a \bullet e_0^\at{\idx}) \land ((a = a_0) \land (\forall j)(\idxinitial \leq j < \idx \impl \neg (a_0 \bullet e_0^\at{j})) \\
    &\quad \quad \lor ((\exists j)(\idxinitial \leq j < \idx \land a = e_0^\at{j}) \land 
  ...
  \begin{align*}
    ...
    &~~= (a = e_0^\at{\idx}) \land (\exists b) ((b \bullet e_0^\at{\idx}) \land ((b = a_0 \land 
                                                (\forall j)(\idxinitial \leq j < \idx \impl \neg (a_0 \bullet e_0^\at{j})) \\
    &\quad \quad \lor ((\exists j)(\idxinitial \leq j < \idx \land b = e_0^\at{j}) \land 
