...
..
   devguide-meta:
   covers: counterexample generation, model parsing, giant-step and small-step
   RAC, and counterexample classification
   primary_code: gnat2why/, why3/, src/why/
   when_to_read: changes to counterexamples, RAC execution, model processing,
   or counterexample display
