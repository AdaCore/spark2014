...
latex_documents = [
    (master_doc, 'GNATproveDeveloperGuide.tex',
     u'GNATprove Developer Guide Documentation',
     u'AdaCore and Altran', 'manual'),
]
...
man_pages = [
    (master_doc, 'gnatprovedeveloperguide',
     u'GNATprove Developer Guide Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'GNATproveDeveloperGuide',
     u'GNATprove Developer Guide Documentation',
     author, 'GNATproveDeveloperGuide', 'One line description of project.',
     'Miscellaneous'),
]
