...
want to obey the Liskov Substitution Principle. In this case, the standard
...
Liskov Substitution Principle. Ada rules for inheritance of \verb|Pre'Class| and
...
frame condition. In order to ensure automatically that the Liskov Substitution
