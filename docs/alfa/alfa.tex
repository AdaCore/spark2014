...
For each path-variable of mode ``out'' in the frame condition of
\verb|F| (see Section~\ref{Ada2SPARK:variables}) whose type defines a dynamic
invariant (see Section~\ref{Ada2SPARK:types}), the corresponding dynamic
...
to translate calls that take slices as actual parameters.
...
\subsubsection{Expressions}
 ...
 parameters in calls should be given in the order of their definition,
