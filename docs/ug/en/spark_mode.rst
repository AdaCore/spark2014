...
.. literalinclude:: /examples/ug__selected_subprograms/selected_subprograms.ads
   :language: ada
   :linenos:
...
.. literalinclude:: /examples/ug__selected_subprograms/selected_subprograms.adb
   :language: ada
   :linenos:
...
.. literalinclude:: /examples/ug__selected_units/selected_units.ads
   :language: ada
   :linenos:
...
.. literalinclude:: /examples/ug__selected_units/selected_units.adb
   :language: ada
   :linenos:
...
.. literalinclude:: /examples/ug__use_generic/exclude_generic_unit_body.ads
   :language: ada
   :linenos:

.. literalinclude:: /examples/ug__use_generic/exclude_generic_unit_body.adb
   :language: ada
   :linenos:

.. literalinclude:: /examples/ug__use_generic/use_generic.ads
   :language: ada
   :linenos:

.. literalinclude:: /examples/ug__use_generic/use_generic.adb
   :language: ada
   :linenos:
...
.. literalinclude:: /examples/ug__exclude_selected_parts/exclude_selected_parts.ads
   :language: ada
   :linenos:
