...
begin
   ...
   if  Has_Element(L1, Next(L1, First(L1))) then
      Ada.Text_IO.Put_Line("OK");
      Test_Element(L1, First(L1),2,"Has_Element of inserted Element after Insertion");
      Test_Element(L1, Next(L1, First(L1)),1,"Has_Element of inserted Element after Insertion");
   else
   ...
   if  Has_Element(L3, Next(L3, First(L3))) then
      Ada.Text_IO.Put_Line("OK");
      Test_Element(L3, Next(L3, First(L3)),2,"Has_Element of Left in range 2");
   else
   ...
   if  Has_Element(L3, Next(L3, First(L3))) then
      Ada.Text_IO.Put_Line("OK");
      Test_Element(L3, Next(L3, First(L3)),1,"Has_Element of Right in range 2");
   else
