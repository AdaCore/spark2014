...
use type AIP.Pbufs.Pbuf_Id;
use type AIP.TCP.TCB_Id;
...
package body RAW_Tcpecho is
   ...
   Echo_Accept_Cb_Id :
     constant AIP.Callbacks.Callback_Id := Echo_Accept_Cb'Address;
   Echo_Err_Cb_Id    :
     constant AIP.Callbacks.Callback_Id := Echo_Err_Cb'Address;
   Echo_Recv_Cb_Id   :
     constant AIP.Callbacks.Callback_Id := Echo_Recv_Cb'Address;
   Echo_Poll_Cb_Id   :
     constant AIP.Callbacks.Callback_Id := Echo_Poll_Cb'Address;
   Echo_Sent_Cb_Id   :
     constant AIP.Callbacks.Callback_Id := Echo_Sent_Cb'Address;

   --  Local subprogram declarations

   procedure Echo_Send (Tcb : AIP.TCP.TCB_Id; Sid : ES_Id);

   procedure Echo_Close (Tcb : AIP.TCP.TCB_Id; Sid : ES_Id);
