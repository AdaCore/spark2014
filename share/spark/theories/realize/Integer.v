...
(* Why3 goal *)
Lemma bool_eq_axiom : forall (x:Z), forall (y:Z), ((bool_eq x y) = true) <->
  (x = y).
exact Z.eqb_eq.
Qed.

(* Why3 goal *)
Lemma bool_ne_axiom : forall (x:Z), forall (y:Z), ((bool_ne x y) = true) <->
  ~ (x = y).
intros x y.
...
(* Why3 goal *)
Lemma bool_lt_axiom : forall (x:Z), forall (y:Z), ((bool_lt x y) = true) <->
  (x < y)%Z.
unfold bool_lt; exact Z.ltb_lt.
Qed.

(* Why3 goal *)
Lemma bool_int__le_axiom : forall (x:Z), forall (y:Z), ((bool_le x
  y) = true) <-> (x <= y)%Z.
...
(* Why3 goal *)
Lemma bool_gt_axiom : forall (x:Z), forall (y:Z), ((bool_gt x y) = true) <->
  (y < x)%Z.
...
(* Why3 goal *)
Lemma bool_ge_axiom : forall (x:Z), forall (y:Z), ((bool_ge x y) = true) <->
  (y <= x)%Z.
