...
--  This is the Hi-Lite target dependent version of package body Sdefault.

--  This package body provides the Hi-Lite implementation of the routines
...
--  the Makefile. In the case of Hi-Lite this package body exists because it
...
--      +-- lib
--      |
--      |-- adainclude [Hi-Lite Ada library sources]

--  The user can install Hi-Lite in any <install-dir> but is not allowed to
--  modify the directory hierarchy shown above.

--  To locate directories adainclude and adalib the Hi-Lite backends
