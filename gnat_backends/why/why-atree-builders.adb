...
package body Why.Atree.Builders is
   ...
   begin
      Result.Ada_Node :=
        Ada_Node;
      Result.CS_Precondition :=
        +(W_Precondition_Valid_Id (Precondition));
      Set_Link (Result.CS_Precondition, New_Id);
      Result.CS_Result_Name :=
        +(W_Identifier_Valid_Id (Result_Name));
      Set_Link (Result.CS_Result_Name, New_Id);
      Result.CS_Return_Type :=
      ...
      Set_Link (Result.CS_Effects, New_Id);
      Result.CS_Postcondition :=
        +(W_Postcondition_Valid_Id (Postcondition));
      Set_Link (Result.CS_Postcondition, New_Id);
      Result.Link := Why_Empty;
      Result.Checked := True;
      Set_Node (New_Id, Result);
   ...
   begin
      ...
      Set_Link (Result.RT_Right, New_Id);
      Result.RT_Op2 :=
        +(W_Relation_Valid_Id (Op2));
      Set_Link (Result.RT_Op2, New_Id);
      Result.RT_Right2 :=
        +(W_Term_Valid_Id (Right2));
      Set_Link (Result.RT_Right2, New_Id);
      Result.Link := Why_Empty;
      Result.Checked := True;
      Set_Node (New_Id, Result);
   ...
   begin
      Result.Ada_Node :=
        Ada_Node;
      Result.T_External :=
        +(W_External_Valid_Id (External));
      Set_Link (Result.T_External, New_Id);
      Result.T_Type_Parameters := New_List;
      for J in Type_Parameters'Range loop
         pragma Assert
           (Identifier_Id_Kind_Valid
            (+(W_Identifier_Valid_Id (Type_Parameters (J)))));
         pragma Assert
           (Identifier_Id_Valid
            (+(W_Identifier_Valid_Id (Type_Parameters (J)))));
         Append
      ...
      Set_Link (Result.T_Name, New_Id);
      Result.T_Definition :=
        +(W_Type_Definition_Valid_Id (Definition));
      Set_Link (Result.T_Definition, New_Id);
      Result.Link := Why_Empty;
      Result.Checked := True;
      Set_Node (New_Id, Result);
   ...
   begin
      ...
      for J in Arg_Types'Range loop
         pragma Assert
           (Logic_Arg_Type_Id_Kind_Valid
            (+(W_Logic_Arg_Type_Valid_Id (Arg_Types (J)))));
         pragma Assert
           (Logic_Arg_Type_Id_Valid
            (+(W_Logic_Arg_Type_Valid_Id (Arg_Types (J)))));
         Append
   ...
   begin
      ...
      for J in Arg_List'Range loop
         pragma Assert
           (Primitive_Type_Id_Kind_Valid
            (+(W_Primitive_Type_Valid_Id (Arg_List (J)))));
         pragma Assert
           (Primitive_Type_Id_Valid
            (+(W_Primitive_Type_Valid_Id (Arg_List (J)))));
         Append
   ...
   begin
      ...
      for J in Writes'Range loop
         pragma Assert
           (Identifier_Id_Kind_Valid
            (+(W_Identifier_Valid_Id (Writes (J)))));
         pragma Assert
           (Identifier_Id_Valid
            (+(W_Identifier_Valid_Id (Writes (J)))));
         Append
      ...
      for J in Raises'Range loop
         pragma Assert
           (Identifier_Id_Kind_Valid
            (+(W_Identifier_Valid_Id (Raises (J)))));
         pragma Assert
           (Identifier_Id_Valid
            (+(W_Identifier_Valid_Id (Raises (J)))));
         Append
   ...
   begin
      ...
      for J in Handlers'Range loop
         pragma Assert
           (Exn_Condition_Id_Kind_Valid
            (+(W_Exn_Condition_Valid_Id (Handlers (J)))));
         pragma Assert
           (Exn_Condition_Id_Valid
            (+(W_Exn_Condition_Valid_Id (Handlers (J)))));
         Append
   ...
   begin
      ...
      Set_Link (Result.RS_Name, New_Id);
      Result.RS_Exn_Type :=
        +(W_Value_Type_Valid_Id (Exn_Type));
      Set_Link (Result.RS_Exn_Type, New_Id);
      Result.Link := Why_Empty;
      Result.Checked := True;
      Set_Node (New_Id, Result);
   ...
   begin
      Result.Ada_Node :=
        Ada_Node;
      Result.LA_Invariant :=
        +(W_Assertion_Valid_Id (Invariant));
      Set_Link (Result.LA_Invariant, New_Id);
      Result.LA_Variant :=
        +(W_Wf_Arg_Valid_Id (Variant));
      Set_Link (Result.LA_Variant, New_Id);
   ...
   begin
      ...
      for J in Declarations'Range loop
         pragma Assert
           (Declaration_Id_Kind_Valid
            (+(W_Declaration_Valid_Id (Declarations (J)))));
         pragma Assert
           (Declaration_Id_Valid
            (+(W_Declaration_Valid_Id (Declarations (J)))));
         Append
   ...
   begin
      ...
      Set_Link (Result.ED_Name, New_Id);
      Result.ED_Parameter :=
        +(W_Primitive_Type_Valid_Id (Parameter));
      Set_Link (Result.ED_Parameter, New_Id);
      Result.Link := Why_Empty;
      Result.Checked := True;
      Set_Node (New_Id, Result);
