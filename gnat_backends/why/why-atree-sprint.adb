...
package body Why.Atree.Sprint is
   ...
   is
      ...
      Variables       : constant List :=
                          Get_List (Universal_Quantif_Get_Variables (Node));
      Position        : Cursor := First (Variables);
   ...
   is
      ...
      Variables       : constant List :=
                          Get_List (Existential_Quantif_Get_Variables (Node));
      Position        : Cursor := First (Variables);
      Var_Type        : constant W_Primitive_Type_Id :=
   ...
   is
      ...
      Triggers : constant List :=
                   Get_List (Triggers_Get_Triggers (Node));
      Position : Cursor := First (Triggers);
   begin
      P (O, "[");
      while Position /= No_Element loop
         declare
            Trigger : constant W_Trigger_Id := Element (Position);
         begin
            Traverse (State, Trigger);
         end;
   ...
   is
      ...
      Terms    : constant List :=
                   Get_List (Trigger_Get_Terms (Node));
      Position : Cursor := First (Terms);
   begin
      while Position /= No_Element loop
         declare
            Term : constant W_Term_Id := Element (Position);
         begin
            Traverse (State, Term);
         end;
   ...
   begin
      ...
      while Position /= No_Element loop
         ...
         declare
            Param : constant W_Identifier_Id := Element (Position);
         begin
   ...
   is
      ...
      Names      : constant List :=
                     Get_List (Logic_Get_Names (Node));
      Position   : Cursor := First (Names);
   ...
   begin
      ...
      while Position /= No_Element loop
         declare
            Name : constant W_Identifier_Id := Element (Position);
         begin
            Traverse (State, Name);
         end;
   ...
   is
      ...
      Binders  : constant List :=
                   Get_List (Function_Get_Binders (Node));
      Position : Cursor := First (Binders);
   begin
      P (O, "function ");
      Traverse
        (State,
      ...
      while Position /= No_Element loop
         declare
            Binder : constant W_Logic_Binder_Id := Element (Position);
         begin
            Traverse (State, Binder);
         end;
   ...
   is
      ...
      Binders  : constant List :=
                   Get_List (Predicate_Definition_Get_Binders (Node));
      Position : Cursor := First (Binders);
   begin
      P (O, "predicate ");
      Traverse
   ...
   is
      ...
      Arg_Types : constant List :=
                    Get_List (Logic_Type_Get_Arg_Types (Node));
      Position  : Cursor := First (Arg_Types);
   begin
      while Position /= No_Element loop
         declare
            Arg_Type : constant W_Logic_Arg_Type_Id := Element (Position);
         begin
            Traverse (State, Arg_Type);
         end;
