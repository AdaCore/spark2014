...
package Why.Atree.Builders is
   ...
   function New_Identifier
     ...
     return W_Identifier_Valid_Id with
     Pre =>
       (True
        and then True);
   ...
   function New_Type_Prop
     (Ada_Node : Node_Id := Empty)
     return W_Type_Prop_Valid_Id with
     Pre => True;

   function New_Type_Int
     (Ada_Node : Node_Id := Empty)
     return W_Type_Int_Valid_Id with
     Pre => True;

   function New_Type_Bool
     (Ada_Node : Node_Id := Empty)
     return W_Type_Bool_Valid_Id with
     Pre => True;

   function New_Type_Real
     (Ada_Node : Node_Id := Empty)
     return W_Type_Real_Valid_Id with
     Pre => True;

   function New_Type_Unit
     (Ada_Node : Node_Id := Empty)
     return W_Type_Unit_Valid_Id with
     Pre => True;

   function New_Abstract_Type
     (Ada_Node : Node_Id := Empty;
      Name     : W_Identifier_Valid_Id)
     return W_Abstract_Type_Valid_Id with
     Pre =>
       (Is_Root (+Name));
   ...
   function New_Generic_Formal_Type
     (Ada_Node : Node_Id := Empty;
      Name     : W_Identifier_Valid_Id)
     return W_Generic_Formal_Type_Valid_Id with
     Pre =>
       (Is_Root (+Name));
   ...
   function New_Generic_Actual_Type_Chain
     (Ada_Node   : Node_Id := Empty;
      ...
      Name       : W_Identifier_Valid_Id)
     return W_Generic_Actual_Type_Chain_Valid_Id with
     Pre =>
       (True
   ...
   function New_Array_Type
     ...
     return W_Array_Type_Valid_Id with
     Pre =>
   ...
   function New_Integer_Constant
     (Ada_Node : Node_Id := Empty;
      Value    : Uint)
     return W_Integer_Constant_Valid_Id with
     Pre =>
       (True);
   ...
   function New_Real_Constant
     (Ada_Node : Node_Id := Empty;
      Value    : Ureal)
     return W_Real_Constant_Valid_Id with
     Pre =>
       (True);

   function New_True_Literal
     (Ada_Node : Node_Id := Empty)
     return W_True_Literal_Valid_Id with
     Pre => True;

   function New_False_Literal
     (Ada_Node : Node_Id := Empty)
     return W_False_Literal_Valid_Id with
     Pre => True;

   function New_Void_Literal
     (Ada_Node : Node_Id := Empty)
     return W_Void_Literal_Valid_Id with
     Pre => True;
   ...
   function New_Arith_Operation
     ...
     return W_Arith_Operation_Valid_Id with
     Pre =>
       (Is_Root (+Left)
        and then Is_Root (+Op)
   ...
   function New_Negative_Term
     ...
     return W_Negative_Term_Valid_Id with
     Pre =>
       (Is_Root (+Operand));
   ...
   function New_Term_Identifier
     ...
     return W_Term_Identifier_Valid_Id with
     Pre =>
       (Is_Root (+Name)
   ...
   function New_Operation
     ...
     return W_Operation_Valid_Id with
     Pre =>
       (Is_Root (+Name)
        and then True);
   ...
   function New_Named_Term
     ...
     return W_Named_Term_Valid_Id with
     Pre =>
       (Is_Root (+Name)
   ...
   function New_Conditional_Term
     ...
     return W_Conditional_Term_Valid_Id with
     Pre =>
       (Is_Root (+Condition)
   ...
   function New_Matching_Term
     ...
     return W_Matching_Term_Valid_Id with
     Pre =>
       (Is_Root (+Term)
        and then True);
   ...
   function New_Binding_Term
     ...
     return W_Binding_Term_Valid_Id with
     Pre =>
       (Is_Root (+Name)
   ...
   function New_Protected_Term
     (Ada_Node : Node_Id := Empty;
      Term     : W_Term_Valid_Id)
     return W_Protected_Term_Valid_Id with
     Pre =>
       (Is_Root (+Term));

   function New_Op_Add
     (Ada_Node : Node_Id := Empty)
     return W_Op_Add_Valid_Id with
     Pre => True;

   function New_Op_Substract
     (Ada_Node : Node_Id := Empty)
     return W_Op_Substract_Valid_Id with
     Pre => True;

   function New_Op_Multiply
     (Ada_Node : Node_Id := Empty)
     return W_Op_Multiply_Valid_Id with
     Pre => True;

   function New_Op_Divide
     (Ada_Node : Node_Id := Empty)
     return W_Op_Divide_Valid_Id with
     Pre => True;

   function New_Op_Modulo
     (Ada_Node : Node_Id := Empty)
     return W_Op_Modulo_Valid_Id with
     Pre => True;

   function New_True_Literal_Pred
     (Ada_Node : Node_Id := Empty)
     return W_True_Literal_Pred_Valid_Id with
     Pre => True;

   function New_False_Literal_Pred
     (Ada_Node : Node_Id := Empty)
     return W_False_Literal_Pred_Valid_Id with
     Pre => True;

   function New_Predicate_Identifier
     (Ada_Node : Node_Id := Empty;
      Name     : W_Identifier_Valid_Id)
     return W_Predicate_Identifier_Valid_Id with
     Pre =>
       (Is_Root (+Name));
   ...
   function New_Predicate_Instance
     (Ada_Node   : Node_Id := Empty;
      Name       : W_Identifier_Valid_Id;
      Parameters : W_Term_V_Array)
     return W_Predicate_Instance_Valid_Id with
     Pre =>
       (Is_Root (+Name)
        and then True);
   ...
   function New_Related_Terms
     ...
     return W_Related_Terms_Valid_Id with
     Pre =>
       (Is_Root (+Left)
        and then Is_Root (+Op)
        and then Is_Root (+Right)
   ...
   function New_Implication
     ...
     return W_Implication_Valid_Id with
     Pre =>
       (Is_Root (+Left)
        and then Is_Root (+Right));
   ...
   function New_Equivalence
     (Ada_Node : Node_Id := Empty;
      Left     : W_Predicate_Valid_Id;
      Right    : W_Predicate_Valid_Id)
     return W_Equivalence_Valid_Id with
     Pre =>
       (Is_Root (+Left)
        and then Is_Root (+Right));
   ...
   function New_Disjunction
     (Ada_Node : Node_Id := Empty;
      Left     : W_Predicate_Valid_Id;
      Right    : W_Predicate_Valid_Id)
     return W_Disjunction_Valid_Id with
     Pre =>
       (Is_Root (+Left)
        and then Is_Root (+Right));
   ...
   function New_Conjunction
     (Ada_Node : Node_Id := Empty;
      Left     : W_Predicate_Valid_Id;
      Right    : W_Predicate_Valid_Id)
     return W_Conjunction_Valid_Id with
     Pre =>
       (Is_Root (+Left)
        and then Is_Root (+Right));
   ...
   function New_Negation
     ...
     return W_Negation_Valid_Id with
     Pre =>
       (Is_Root (+Operand));
   ...
   function New_Conditional_Pred
     ...
     return W_Conditional_Pred_Valid_Id with
     Pre =>
       (Is_Root (+Condition)
        and then Is_Root (+Then_Part)
        and then Is_Root (+Else_Part));
   ...
   function New_Binding_Pred
     ...
     return W_Binding_Pred_Valid_Id with
     Pre =>
       (Is_Root (+Name)
        and then Is_Root (+Def)
        and then Is_Root (+Context));
   ...
   function New_Universal_Quantif
     ...
     return W_Universal_Quantif_Valid_Id with
     Pre =>
       (True
   ...
   function New_Existential_Quantif
     (Ada_Node  : Node_Id := Empty;
      ...
      Var_Type  : W_Primitive_Type_Valid_Id;
      Pred      : W_Predicate_Valid_Id)
     return W_Existential_Quantif_Valid_Id with
     Pre =>
       (True
        and then Is_Root (+Var_Type)
        and then Is_Root (+Pred));
   ...
   function New_Named_Predicate
     (Ada_Node : Node_Id := Empty;
      Name     : W_Identifier_Valid_Id;
      Pred     : W_Predicate_Valid_Id)
     return W_Named_Predicate_Valid_Id with
     Pre =>
       (Is_Root (+Name)
        and then Is_Root (+Pred));
   ...
   function New_Protected_Predicate
     (Ada_Node : Node_Id := Empty;
      Pred     : W_Predicate_Valid_Id)
     return W_Protected_Predicate_Valid_Id with
     Pre =>
       (Is_Root (+Pred));
   ...
   function New_Pattern
     ...
     return W_Pattern_Valid_Id with
     Pre =>
       (Is_Root (+Constr)
        and then True);
   ...
   function New_Match_Case
     (Ada_Node : Node_Id := Empty;
      ...
      Term     : W_Term_Valid_Id)
     return W_Match_Case_Valid_Id with
     Pre =>
       (Is_Root (+Pattern)
        and then Is_Root (+Term));
   ...
   function New_Triggers
     ...
     return W_Triggers_Valid_Id with
     Pre =>
       (True);
   ...
   function New_Trigger
     ...
     return W_Trigger_Valid_Id with
     Pre =>
       (True);

   function New_Rel_Eq
     (Ada_Node : Node_Id := Empty)
     return W_Rel_Eq_Valid_Id with
     Pre => True;

   function New_Rel_Ne
     (Ada_Node : Node_Id := Empty)
     return W_Rel_Ne_Valid_Id with
     Pre => True;

   function New_Rel_Lt
     (Ada_Node : Node_Id := Empty)
     return W_Rel_Lt_Valid_Id with
     Pre => True;

   function New_Rel_Le
     (Ada_Node : Node_Id := Empty)
     return W_Rel_Le_Valid_Id with
     Pre => True;

   function New_Rel_Gt
     (Ada_Node : Node_Id := Empty)
     return W_Rel_Gt_Valid_Id with
     Pre => True;

   function New_Rel_Ge
     (Ada_Node : Node_Id := Empty)
     return W_Rel_Ge_Valid_Id with
     Pre => True;
   ...
   function New_Function
     (Ada_Node    : Node_Id := Empty;
      ...
      Return_Type : W_Primitive_Type_Valid_Id;
      Def         : W_Term_Valid_Id)
     return W_Function_Valid_Id with
     Pre =>
       (Is_Root (+Name)
        and then True
        and then Is_Root (+Return_Type)
   ...
   function New_Predicate_Definition
     ...
     return W_Predicate_Definition_Valid_Id with
     Pre =>
       (Is_Root (+Name)
        and then True
        and then Is_Root (+Def));
   ...
   function New_Inductive
     ...
     return W_Inductive_Valid_Id with
     Pre =>
       (Is_Root (+Name)
        and then Is_Root (+Logic_Type)
        and then True);
   ...
   function New_External
     (Ada_Node : Node_Id := Empty)
     return W_External_Valid_Id with
     Pre => True;
   ...
   function New_Logic_Type
     ...
     return W_Logic_Type_Valid_Id with
     Pre =>
       (True
        and then Is_Root (+Return_Type));
   ...
   function New_Logic_Binder
     ...
     return W_Logic_Binder_Valid_Id with
     Pre =>
       (Is_Root (+Name)
   ...
   function New_Inductive_Case
     (Ada_Node : Node_Id := Empty;
      Name     : W_Identifier_Valid_Id;
      Pred     : W_Predicate_Valid_Id)
     return W_Inductive_Case_Valid_Id with
     Pre =>
       (Is_Root (+Name)
        and then Is_Root (+Pred));
   ...
   function New_Transparent_Type_Definition
     ...
     return W_Transparent_Type_Definition_Valid_Id with
     Pre =>
       (Is_Root (+Type_Definition));

   function New_Adt_Definition
     (Ada_Node     : Node_Id := Empty;
      Constructors : W_Constr_Decl_V_Array)
     return W_Adt_Definition_Valid_Id with
     Pre =>
       (True);
   ...
   function New_Constr_Decl
     ...
     return W_Constr_Decl_Valid_Id with
     Pre =>
       (Is_Root (+Name)
        and then True);
   ...
   function New_Effects
     ...
     return W_Effects_Valid_Id with
     Pre =>
       (True
        and then True
        and then True);
   ...
   function New_Prog_Constant
     ...
     return W_Prog_Constant_Valid_Id with
     Pre =>
       (Is_Root (+Def));
   ...
   function New_Prog_Identifier
     ...
     return W_Prog_Identifier_Valid_Id with
     Pre =>
       (Is_Root (+Def));
   ...
   function New_Any_Expr
     ...
     return W_Any_Expr_Valid_Id with
     Pre =>
       (Is_Root (+Any_Type));
   ...
   function New_Assignment
     ...
     return W_Assignment_Valid_Id with
     Pre =>
       (Is_Root (+Name)
   ...
   function New_Array_Access
     ...
     return W_Array_Access_Valid_Id with
     Pre =>
       (Is_Root (+Name)
   ...
   function New_Array_Update
     (Ada_Node : Node_Id := Empty;
      ...
      Index    : W_Prog_Valid_Id;
      Value    : W_Prog_Valid_Id)
     return W_Array_Update_Valid_Id with
     Pre =>
       (Is_Root (+Name)
        and then Is_Root (+Index)
        and then Is_Root (+Value));
   ...
   function New_Infix_Call
     ...
     return W_Infix_Call_Valid_Id with
     Pre =>
       (Is_Root (+Left)
   ...
   function New_Prefix_Call
     ...
     return W_Prefix_Call_Valid_Id with
     Pre =>
       (Is_Root (+Prefix)
   ...
   function New_Binding_Prog
     ...
     return W_Binding_Prog_Valid_Id with
     Pre =>
       (Is_Root (+Name)
        and then Is_Root (+Def)
        and then Is_Root (+Context));
   ...
   function New_Binding_Ref
     (Ada_Node : Node_Id := Empty;
      ...
      Def      : W_Prog_Valid_Id;
      Context  : W_Prog_Valid_Id)
     return W_Binding_Ref_Valid_Id with
     Pre =>
       (Is_Root (+Name)
        and then Is_Root (+Def)
        and then Is_Root (+Context));
   ...
   function New_Conditional_Prog
     ...
     return W_Conditional_Prog_Valid_Id with
     Pre =>
       (Is_Root (+Condition)
        and then Is_Root (+Then_Part)
        and then Is_Root (+Else_Part));
   ...
   function New_While_Loop
     ...
     return W_While_Loop_Valid_Id with
     Pre =>
       (Is_Root (+Condition)
   ...
   function New_Statement_Sequence
     ...
     return W_Statement_Sequence_Valid_Id with
     Pre =>
       (True);
   ...
   function New_Post_Assertion
     ...
     return W_Post_Assertion_Valid_Id with
     Pre =>
       (Is_Root (+Prog)
   ...
   function New_Opaque_Assertion
     (Ada_Node : Node_Id := Empty;
      Prog     : W_Prog_Valid_Id;
      Post     : W_Postcondition_Valid_Id)
     return W_Opaque_Assertion_Valid_Id with
     Pre =>
       (Is_Root (+Prog)
        and then Is_Root (+Post));
   ...
   function New_Fun_Def
     (Ada_Node : Node_Id := Empty;
      ...
      Def      : W_Prog_Valid_Id)
     return W_Fun_Def_Valid_Id with
     Pre =>
       (True
   ...
   function New_Binding_Fun
     (Ada_Node : Node_Id := Empty;
      ...
      Def      : W_Prog_Valid_Id;
      Context  : W_Prog_Valid_Id)
     return W_Binding_Fun_Valid_Id with
     Pre =>
       (Is_Root (+Name)
        and then True
        and then Is_Root (+Pre)
   ...
   function New_Binding_Rec
     (Ada_Node : Node_Id := Empty;
      ...
      Context  : W_Prog_Valid_Id)
     return W_Binding_Rec_Valid_Id with
     Pre =>
       (Is_Root (+Recfun)
        and then Is_Root (+Context));
   ...
   function New_Prog_Call
     ...
     return W_Prog_Call_Valid_Id with
     Pre =>
       (Is_Root (+Name)
        and then True);
   ...
   function New_Try_Block
     ...
     return W_Try_Block_Valid_Id with
     Pre =>
       (Is_Root (+Prog)
        and then True);
   ...
   function New_Begin_Block
     (Ada_Node : Node_Id := Empty;
      Prog     : W_Prog_Valid_Id)
     return W_Begin_Block_Valid_Id with
     Pre =>
       (Is_Root (+Prog));
   ...
   function New_Protected_Prog
     (Ada_Node : Node_Id := Empty;
      Prog     : W_Prog_Valid_Id)
     return W_Protected_Prog_Valid_Id with
     Pre =>
       (Is_Root (+Prog));

   function New_Op_Add_Prog
     (Ada_Node : Node_Id := Empty)
     return W_Op_Add_Prog_Valid_Id with
     Pre => True;

   function New_Op_Substract_Prog
     (Ada_Node : Node_Id := Empty)
     return W_Op_Substract_Prog_Valid_Id with
     Pre => True;

   function New_Op_Multiply_Prog
     (Ada_Node : Node_Id := Empty)
     return W_Op_Multiply_Prog_Valid_Id with
     Pre => True;

   function New_Op_Divide_Prog
     (Ada_Node : Node_Id := Empty)
     return W_Op_Divide_Prog_Valid_Id with
     Pre => True;

   function New_Op_Mod_Prog
     (Ada_Node : Node_Id := Empty)
     return W_Op_Mod_Prog_Valid_Id with
     Pre => True;

   function New_Op_Eq_Prog
     (Ada_Node : Node_Id := Empty)
     return W_Op_Eq_Prog_Valid_Id with
     Pre => True;

   function New_Op_Ne_Prog
     (Ada_Node : Node_Id := Empty)
     return W_Op_Ne_Prog_Valid_Id with
     Pre => True;

   function New_Op_Lt_Prog
     (Ada_Node : Node_Id := Empty)
     return W_Op_Lt_Prog_Valid_Id with
     Pre => True;

   function New_Op_Le_Prog
     (Ada_Node : Node_Id := Empty)
     return W_Op_Le_Prog_Valid_Id with
     Pre => True;

   function New_Op_Gt_Prog
     (Ada_Node : Node_Id := Empty)
     return W_Op_Gt_Prog_Valid_Id with
     Pre => True;

   function New_Op_Ge_Prog
     (Ada_Node : Node_Id := Empty)
     return W_Op_Ge_Prog_Valid_Id with
     Pre => True;

   function New_Op_Or_Else_Prog
     (Ada_Node : Node_Id := Empty)
     return W_Op_Or_Else_Prog_Valid_Id with
     Pre => True;

   function New_Op_And_Then_Prog
     (Ada_Node : Node_Id := Empty)
     return W_Op_And_Then_Prog_Valid_Id with
     Pre => True;

   function New_Op_Minus_Prog
     (Ada_Node : Node_Id := Empty)
     return W_Op_Minus_Prog_Valid_Id with
     Pre => True;

   function New_Op_Not_Prog
     (Ada_Node : Node_Id := Empty)
     return W_Op_Not_Prog_Valid_Id with
     Pre => True;
   ...
   function New_Handler
     (Ada_Node  : Node_Id := Empty;
      ...
      Def       : W_Prog_Valid_Id)
     return W_Handler_Valid_Id with
     Pre =>
       (Is_Root (+Name)
        and then Is_Root (+Parameter)
        and then Is_Root (+Def));
   ...
   function New_Global_Binding
     (Ada_Node : Node_Id := Empty;
      ...
      Pre      : W_Precondition_Valid_Id;
      Def      : W_Prog_Valid_Id)
     return W_Global_Binding_Valid_Id with
     Pre =>
       (Is_Root (+Name)
        and then True
        and then Is_Root (+Pre)
   ...
   function New_Global_Rec_Binding
     ...
     return W_Global_Rec_Binding_Valid_Id with
     Pre =>
       (Is_Root (+Name));
   ...
   function New_Exception_Declaration
     ...
     return W_Exception_Declaration_Valid_Id with
     Pre =>
       (Is_Root (+Name)
        and then Is_Root (+Parameter));
   ...
   function New_Logic_Declaration
     ...
     return W_Logic_Declaration_Valid_Id with
     Pre =>
       (Is_Root (+Decl));
   ...
   function New_Include_Declaration
     (Ada_Node : Node_Id := Empty;
      Name     : W_Identifier_Valid_Id)
     return W_Include_Declaration_Valid_Id with
     Pre =>
       (Is_Root (+Name));
   ...
   function New_Type_Prop
     (Ada_Node : Node_Id := Empty)
     return W_Logic_Return_Type_Id with
     Pre => True;
   function New_Type_Int
     (Ada_Node : Node_Id := Empty)
   ...
   function New_Type_Int
     (Ada_Node : Node_Id := Empty)
     return W_Primitive_Type_Id with
     Pre => True;
   ...
   function New_Type_Int
     (Ada_Node : Node_Id := Empty)
     return W_Logic_Arg_Type_Id with
     Pre => True;
   ...
   function New_Type
     (Ada_Node        : Node_Id := Empty;
      ...
      Name            : W_Identifier_Id;
      Definition      : W_Type_Definition_OId := Why_Empty)
     return W_Logic_Declaration_Class_Id with
     Pre =>
       (Is_Root (+External)
        and then True
        and then Is_Root (+Name)
   ...
   function New_Transparent_Type_Definition
     (Ada_Node        : Node_Id := Empty;
      Type_Definition : W_Primitive_Type_Id)
     return W_Type_Definition_Id with
     Pre =>
       (Is_Root (+Type_Definition));
   function New_Adt_Definition
     (Ada_Node     : Node_Id := Empty;
