(benchmark addelementtologfilewithtruncatechecks.8.1
  :logic AUFNIRA
  :extrasorts 
  ( string
    logfilesstatust
  ...
  (and
    ...
    (=
      numberlogentries___init
      (+
        (*
          (-
            (logfilelistt___length___rcd_element usedlogfiles___init )
            1
          )
          1024
        )
        (logfileentryt___arr_element
          logfileentries___init
          currentlogfile___init
        )
      )
    )
    (<= 0 integer__size )
