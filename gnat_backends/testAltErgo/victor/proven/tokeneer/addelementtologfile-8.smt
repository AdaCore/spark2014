(benchmark addelementtologfile.8.1
  :logic AUFNIRA
  :extrasorts 
  ( string
    logfilesstatust
  ...
  (and
    ...
    (=
      (logfilelistt___length___rcd_element usedlogfiles__2 )
      (+ (logfilelistt___length___rcd_element usedlogfiles ) 1 )
    )
    (=
      (logfileentryt___arr_element
    ...
    (forall
      ...
      (implies
        ...
        (and
          (<=
            free
            (logfilesstatust___arr_element logfilesstatus__2 ?i___1 )
          )
          (<=
            (logfilesstatust___arr_element logfilesstatus__2 ?i___1 )
            used
    ...
    (forall
      ...
      (implies
        ...
        (and
          (<=
            0
            (logfileentryt___arr_element logfileentries__2 ?i___1 )
          )
          (<=
            (logfileentryt___arr_element logfileentries__2 ?i___1 )
            1024
    ...
    (<=
      1
      (logfilelistt___lasti___rcd_element usedlogfiles__2 )
    )
    (<=
      (logfilelistt___lasti___rcd_element usedlogfiles__2 )
      17
    )
    (<= 1 (logfilelistt___head___rcd_element usedlogfiles__2 ) )
    (<=
      (logfilelistt___head___rcd_element usedlogfiles__2 )
      17
    )
    (forall
        (?i___1 Int )
      (implies
        ...
        (and
          (<=
            1
            (logfilelistentriest___arr_element
              (logfilelistt___list___rcd_element usedlogfiles__2 )
              ?i___1
            )
          )
          (<=
