...
- The language shall offer an *unambiguous* semantics. In Ada terminology,
  ...
  potential for the behavior.  An example is the rule which prohibits 
...
could be overridden. An new aspect is provided, which may be applied to a unit
...
the given contract is met by the body as it is not analyzed. It is a matter of
