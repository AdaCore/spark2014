...
(** ** Literals *)
Inductive literal_x: Type :=
    | Integer_Literal_X: Z -> literal_x (* 2.4 *)
    | Boolean_Literal_X: bool -> literal_x (* 3.5.3 *).
...
Inductive expression_x: Type := 
    | E_Literal_X: astnum -> literal_x -> check_flags -> expression_x (* 4.2 *)
...
Inductive statement_x: Type := 
    ...
    | S_ProcCall_X: astnum -> astnum -> procnum -> list expression_x -> statement_x (* 6.4 *) (* the second astnum for the called procedure *)
