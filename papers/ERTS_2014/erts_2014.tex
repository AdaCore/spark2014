...
certain property holds at a certain point in the code, and it would
result is the generation of smaller verification conditions which
would in turn make manual proof easier.
