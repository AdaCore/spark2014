...
\newspark (records, arrays, enumerations, ...) were very helpful and
we found it leads to readable specifications.
...
rather easy and more important clear for the reader.
...
change the code with a loop without early exit, the proof becoming
trivial.
...
value. It would have been impossible to prove this contract. Other
...
the reaction of the automatic prover. The ability to compile and test
the loop invariant is very useful to help ``debug'' the invariant.
