...
verification, assertions have typically been interpreted as formulae in
...
property is not proved. In our experience, a very useful feature of \gnatprove
is its ability to display the paths in the program that lead to unproved
properties. This path can be displayed in GPS or in Eclipse, the two Integrated
Development Environments which support \newspark. The user can also change the
parameters of the tool to perform more precise proofs, at the expense of longer
running time.
