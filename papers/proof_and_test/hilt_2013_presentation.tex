...
\note[item]{Duality of execution and proof of contracts changes the game}
           ...
           \begin{pxcode}[language=SPARK,style=magic,gobble=15]
               ...
               with Postcondition => 
                (for all I in Index_Type =>
                    Occurrences(A, 1, Max_Size, A(I)) =
                    Occurrences(B, 1, Max_Size, A(I)));
           \end{pxcode}
          \end{onlyenv}
         \end{minipage} };
