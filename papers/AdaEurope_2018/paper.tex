...
\begin{figure}[htb!]
\centering
   \includegraphics[width=1\columnwidth]{observe_ex1}
...
\begin{figure}[htb!]
\centering
   \includegraphics[width=0.6\columnwidth]{movingComposite}
...
In the code snippet of Figure~\ref{fig:borrowingComposite}, procedure \var{Swap\_Rec} procedure has an \keyword{in out} formal parameter \var{R} of record type. At the point of
...
in unrestricted state, hence its components \var{R.X} and \var{R.Y} can be successively moved in and out through the call to \var{Swap}, and then borrowed through the call to \var{Swap\_Content}.
...
\centering
  \captionsetup{justification=centering,margin=0.6cm}
   \includegraphics[width=0.9\columnwidth]{observingComposite}
...
\centering
  \captionsetup{justification=centering,margin=0.6cm}
   \includegraphics[width=1\columnwidth]{spark_ex1}
...
\centering
  \captionsetup{justification=centering,margin=0.6cm}
   \includegraphics[width=1\columnwidth]{spark_ex1_proof}
...
\centering
  \captionsetup{justification=centering,margin=0.6cm}
   \includegraphics[width=1\columnwidth]{spark_ex1_exp}
...
them using SMT provers. In Spec\#, Ownership is similarly enforced by proof, to detect violations of the so-called Boogie methodology~\cite{Boogie} \todo{fix this ref}.
