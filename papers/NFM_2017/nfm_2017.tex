...
been fully formally verified in Dafny, Eiffel or Why3. See
...
uniquely defines the model. For example, the access path for a node is
computed from the access path for its parent. Proof of the function \texttt{Model}
...
We must separately specify four properties over red-black trees:
\begin{enumerate}
...
automatic proves used in \gnatprove are usually unable to come up with the appropriate
