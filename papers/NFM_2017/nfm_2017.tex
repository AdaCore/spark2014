...
%% postconditions.
There are few simple top-level contracts for red-black trees.  Many more
...
on a Core i7 with 2,8 GHz and 16 GB RAM, using 4 cores and two successive runs
...
right rotations. On a Core i7 with 2,8 GHz and 16 GB RAM, the running time for
...
takes 2 minutes on a Core i7 with 2,8 GHz and 16 GB RAM.
