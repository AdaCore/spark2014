...
properties on an imperative red black tree implementation using SPARK. This is not an example of what should be a regular
use of the SPARK toolset but rather a tour de force, which aims at demonstrating how far we can go using the tool.

Still the techniques presented on this example can be reused on a much smaller scale. In particular, we have shown that
...
To democratize the use of auto-active techniques, we are also working on integrating simple iteractive proof capabilities
